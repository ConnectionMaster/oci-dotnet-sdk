...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/bds/UpdateIdentityConfiguration.cs.html">here</a> to see an example of how to use UpdateIdentityConfiguration request.
    /// </example>
    public class UpdateIdentityConfigurationRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UpdateIdentityConfigurationDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public UpdateIdentityConfigurationDetails UpdateIdentityConfigurationDetails { get; set; }
