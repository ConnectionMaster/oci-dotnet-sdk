...
namespace Oci.BdsService.Requests
{
    ...
    public class CreateBdsCertificateConfigurationRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "CreateBdsCertificateConfigurationDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public CreateBdsCertificateConfigurationDetails CreateBdsCertificateConfigurationDetails { get; set; }
