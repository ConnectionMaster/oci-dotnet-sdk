...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/bds/ChangeShape.cs.html">here</a> to see an example of how to use ChangeShape request.
    /// </example>
    public class ChangeShapeRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "ChangeShapeDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public ChangeShapeDetails ChangeShapeDetails { get; set; }
