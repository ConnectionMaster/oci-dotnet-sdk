...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/bds/UpdateBdsInstance.cs.html">here</a> to see an example of how to use UpdateBdsInstance request.
    /// </example>
    public class UpdateBdsInstanceRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UpdateBdsInstanceDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public UpdateBdsInstanceDetails UpdateBdsInstanceDetails { get; set; }
