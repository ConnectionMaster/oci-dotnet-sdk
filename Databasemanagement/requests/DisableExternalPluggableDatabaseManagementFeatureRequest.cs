...
namespace Oci.DatabasemanagementService.Requests
{
    ...
    public class DisableExternalPluggableDatabaseManagementFeatureRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "DisableExternalPluggableDatabaseManagementFeatureDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public DisableExternalPluggableDatabaseManagementFeatureDetails DisableExternalPluggableDatabaseManagementFeatureDetails { get; set; }
