...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/databasemanagement/GetHeatWaveFleetMetric.cs.html">here</a> to see an example of how to use GetHeatWaveFleetMetric request.
    /// </example>
    public class GetHeatWaveFleetMetricRequest : Oci.Common.IOciRequest
    {
        ...
        /// </value>
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "filterByHeatWaveStatus")]
        public System.Nullable<HeatWaveClusterStatus> FilterByHeatWaveStatus { get; set; }
        
        /// <value>
        /// The parameter to filter by HeatWave node shape.
        /// </value>
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "filterByHeatWaveShape")]
        ...
        /// </value>
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "isHeatWaveLakehouseEnabled")]
