...
namespace Oci.DatabasemanagementService.Requests
{
    ...
    public class EnableAutonomousDatabaseManagementFeatureRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "EnableAutonomousDatabaseManagementFeatureDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public EnableAutonomousDatabaseManagementFeatureDetails EnableAutonomousDatabaseManagementFeatureDetails { get; set; }
