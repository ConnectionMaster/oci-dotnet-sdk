...
{
    /// <summary>
    /// The details for updating the cloud [Management Agent Cloud Service (MACS)](https://docs.oracle.com/iaas/management-agents/index.html)
    /// connector used to connect to a cloud DB system component.
    /// 
    /// </summary>
    public class UpdateCloudDbSystemMacsConnectorDetails : UpdateCloudDbSystemConnectorDetails
    {
