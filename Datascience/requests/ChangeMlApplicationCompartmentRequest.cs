...
namespace Oci.DatascienceService.Requests
{
    ...
    public class ChangeMlApplicationCompartmentRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "ChangeMlApplicationCompartmentDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public ChangeMlApplicationCompartmentDetails ChangeMlApplicationCompartmentDetails { get; set; }
