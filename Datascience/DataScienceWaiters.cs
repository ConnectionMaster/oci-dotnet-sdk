...
namespace Oci.DatascienceService
{
    ...
    public class DataScienceWaiters
    {
        ...
        public Waiter<GetComputeTargetRequest, GetComputeTargetResponse> ForComputeTarget(GetComputeTargetRequest request, params ComputeTargetLifecycleState[] targetStates)
        {
            return this.ForComputeTarget(request, WaiterConfiguration.DefaultWaiterConfiguration, targetStates);
        }
        ...
        /// <param name="targetStates">Desired resource states. If multiple states are provided then the waiter will return once the resource reaches any of the provided states</param>
        /// <returns>a new Oci.common.Waiter instance</returns>
        public Waiter<GetComputeTargetRequest, GetComputeTargetResponse> ForComputeTarget(GetComputeTargetRequest request, WaiterConfiguration config, params ComputeTargetLifecycleState[] targetStates)
        {
            var agent = new WaiterAgent<GetComputeTargetRequest, GetComputeTargetResponse>(
                request,
                request => client.GetComputeTarget(request),
                response => targetStates.Contains(response.ComputeTarget.LifecycleState.Value),
                targetStates.Contains(ComputeTargetLifecycleState.Deleted)
            );
            return new Waiter<GetComputeTargetRequest, GetComputeTargetResponse>(config, agent);
        }
        /// <summary>
        /// Creates a waiter using default wait configuration.
        /// </summary>
