...
{
    public class ListMlApplicationInstanceViewsResponse : Oci.Common.OciResponse
    {
        ...
        public MlApplicationInstanceViewCollection MlApplicationInstanceViewCollection { get; set; }
