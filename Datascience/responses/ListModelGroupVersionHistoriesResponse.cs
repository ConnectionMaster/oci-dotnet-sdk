...
{
    public class ListModelGroupVersionHistoriesResponse : Oci.Common.OciResponse
    {
        ...
        public System.Collections.Generic.List<ModelGroupVersionHistorySummary> Items { get; set; }
