...
{
    public class ListModelDeploymentModelStatesResponse : Oci.Common.OciResponse
    {
        ...
        public System.Collections.Generic.List<ModelDeploymentModelStateSummary> Items { get; set; }
