...
namespace Oci.DatascienceService.Models
{
    ...
    public class ModelDeploymentConfigurationDetailsModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(ModelDeploymentConfigurationDetails);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(ModelDeploymentConfigurationDetails);
            ...
            {
                logger.Warn($"The type {discriminator} is not present under ModelDeploymentConfigurationDetails! Returning null value.");
            }
            return obj;
        }
    }
