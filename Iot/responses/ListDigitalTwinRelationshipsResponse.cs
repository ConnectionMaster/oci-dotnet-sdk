...
{
    public class ListDigitalTwinRelationshipsResponse : Oci.Common.OciResponse
    {
        ...
        public DigitalTwinRelationshipCollection DigitalTwinRelationshipCollection { get; set; }
