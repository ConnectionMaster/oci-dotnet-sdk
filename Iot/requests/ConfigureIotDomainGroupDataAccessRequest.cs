...
namespace Oci.IotService.Requests
{
    ...
    public class ConfigureIotDomainGroupDataAccessRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "ConfigureIotDomainGroupDataAccessDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public ConfigureIotDomainGroupDataAccessDetails ConfigureIotDomainGroupDataAccessDetails { get; set; }
