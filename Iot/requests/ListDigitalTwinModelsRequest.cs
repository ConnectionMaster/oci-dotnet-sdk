...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/iot/ListDigitalTwinModels.cs.html">here</a> to see an example of how to use ListDigitalTwinModels request.
    /// </example>
    public class ListDigitalTwinModelsRequest : Oci.Common.IOciRequest
    {
        ...
        /// <value>
        /// Filters resources by spec URI prefix. For example, to search all versions of the `dtmi:Example: device;1 model, pass the prefix without the version: dtmi:
        /// </value>
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "specUriStartsWith")]
