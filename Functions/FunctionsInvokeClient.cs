...
namespace Oci.FunctionsService
{
    ...
    public class FunctionsInvokeClient : ClientBase
    {
        ...
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/functions/InvokeFunction.cs.html">here</a> to see an example of how to use InvokeFunction API.</example>
