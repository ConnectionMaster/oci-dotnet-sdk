...
namespace Oci.FunctionsService
{
    ...
    /// to any list operations of WorkRequestManagement where multiple pages of data may be fetched.
    ...
    /// </summary>
    public class WorkRequestManagementPaginators
    {
        private readonly WorkRequestManagementClient client;

        public WorkRequestManagementPaginators(WorkRequestManagementClient client)
        {
            this.client = client;
        }
