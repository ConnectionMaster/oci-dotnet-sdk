...
namespace Oci.WaaService.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(WebAppAccelerationModelConverter))]
    public class WebAppAcceleration 
    {
    ...
    public class WebAppAccelerationModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(WebAppAcceleration);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(WebAppAcceleration);
            var discriminator = jsonObject["backendType"].Value<string>();
            switch (discriminator)
            {
                case "LOAD_BALANCER":
                    obj = new WebAppAccelerationLoadBalancer();
                    break;
            }
            if (obj != null)
            {
            ...
            {
                logger.Warn($"The type {discriminator} is not present under WebAppAcceleration! Returning null value.");
            }
            return obj;
        }
    }
