...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/capacitymanagement/UpdateOccCapacityRequest.cs.html">here</a> to see an example of how to use UpdateOccCapacityRequest request.
    /// </example>
    public class UpdateOccCapacityRequestRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UpdateOccCapacityRequestDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public UpdateOccCapacityRequestDetails UpdateOccCapacityRequestDetails { get; set; }
