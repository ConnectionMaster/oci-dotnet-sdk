...
namespace Oci.CapacitymanagementService.Requests
{
    ...
    public class CreateOccAvailabilityCatalogRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "CreateOccAvailabilityCatalogDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public CreateOccAvailabilityCatalogDetails CreateOccAvailabilityCatalogDetails { get; set; }
