...
namespace Oci.CapacitymanagementService.Requests
{
    ...
    public class BulkCreateOccmDemandSignalItemRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "BulkCreateOccmDemandSignalItemDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public BulkCreateOccmDemandSignalItemDetails BulkCreateOccmDemandSignalItemDetails { get; set; }
