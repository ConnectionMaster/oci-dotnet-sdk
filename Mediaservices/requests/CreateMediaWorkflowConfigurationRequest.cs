...
namespace Oci.MediaservicesService.Requests
{
    ...
    public class CreateMediaWorkflowConfigurationRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "CreateMediaWorkflowConfigurationDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public CreateMediaWorkflowConfigurationDetails CreateMediaWorkflowConfigurationDetails { get; set; }
