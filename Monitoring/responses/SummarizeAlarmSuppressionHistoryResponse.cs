...
{
    public class SummarizeAlarmSuppressionHistoryResponse : Oci.Common.OciResponse
    {
        ...
        public AlarmSuppressionHistoryItemCollection AlarmSuppressionHistoryItemCollection { get; set; }
