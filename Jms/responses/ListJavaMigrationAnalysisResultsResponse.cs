...
{
    public class ListJavaMigrationAnalysisResultsResponse : Oci.Common.OciResponse
    {
        ...
        public JavaMigrationAnalysisResultCollection JavaMigrationAnalysisResultCollection { get; set; }
