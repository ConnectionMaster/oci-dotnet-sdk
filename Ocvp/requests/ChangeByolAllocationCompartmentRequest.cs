...
namespace Oci.OcvpService.Requests
{
    ...
    public class ChangeByolAllocationCompartmentRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "ChangeByolAllocationCompartmentDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public ChangeByolAllocationCompartmentDetails ChangeByolAllocationCompartmentDetails { get; set; }
