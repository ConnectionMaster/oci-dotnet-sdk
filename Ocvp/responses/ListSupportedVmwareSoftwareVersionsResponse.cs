...
{
    public class ListSupportedVmwareSoftwareVersionsResponse : Oci.Common.OciResponse
    {
        ...
        public SupportedVmwareSoftwareVersionCollection SupportedVmwareSoftwareVersionCollection { get; set; }
