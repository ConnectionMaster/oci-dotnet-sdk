...
{
    public class ListSupportedCommitmentsResponse : Oci.Common.OciResponse
    {
        ...
        public SupportedCommitmentSummaryCollection SupportedCommitmentSummaryCollection { get; set; }
