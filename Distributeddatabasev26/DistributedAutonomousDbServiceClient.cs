...
using Oci.Distributeddatabasev26Service.Requests;
using Oci.Distributeddatabasev26Service.Responses;
...
namespace Oci.Distributeddatabasev26Service
{
    ...
    public class DistributedAutonomousDbServiceClient : RegionalClientBase
    {
        ...
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/distributeddatabasev26/AddDistributedAutonomousDatabaseGdsControlNode.cs.html">here</a> to see an example of how to use AddDistributedAutonomousDatabaseGdsControlNode API.</example>
        public async Task<AddDistributedAutonomousDatabaseGdsControlNodeResponse> AddDistributedAutonomousDatabaseGdsControlNode(AddDistributedAutonomousDatabaseGdsControlNodeRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            try
            {
                ...
                ApiDetails apiDetails = new ApiDetails
                {
                    ...
                    ApiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/AddDistributedAutonomousDatabaseGdsControlNode",
        ...
        /// <param name="completionOption">The completion option for this operation. Optional.</param>
        /// <returns>A response object containing details about the completed operation</returns>
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/distributeddatabasev26/ChangeDistributedAutonomousDatabaseCompartment.cs.html">here</a> to see an example of how to use ChangeDistributedAutonomousDatabaseCompartment API.</example>
        public async Task<ChangeDistributedAutonomousDatabaseCompartmentResponse> ChangeDistributedAutonomousDatabaseCompartment(ChangeDistributedAutonomousDatabaseCompartmentRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            try
            {
                ...
                ApiDetails apiDetails = new ApiDetails
                {
                    ...
                    RequestEndpoint = $"{method.Method} {requestMessage.RequestUri}",
                    ApiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/ChangeDistributedAutonomousDatabaseCompartment",
                    UserAgent = this.GetUserAgent()
                };
                this.restClient.CheckHttpResponseMessage(requestMessage, responseMessage, apiDetails);
                logger.Debug($"Total Latency for this API call is: {stopWatch.ElapsedMilliseconds} ms");
        ...
        /// <param name="completionOption">The completion option for this operation. Optional.</param>
        /// <returns>A response object containing details about the completed operation</returns>
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/distributeddatabasev26/ChangeDistributedAutonomousDbBackupConfig.cs.html">here</a> to see an example of how to use ChangeDistributedAutonomousDbBackupConfig API.</example>
        public async Task<ChangeDistributedAutonomousDbBackupConfigResponse> ChangeDistributedAutonomousDbBackupConfig(ChangeDistributedAutonomousDbBackupConfigRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            Uri uri = new Uri(this.restClient.GetEndpoint(), System.IO.Path.Combine(basePathWithoutHost, "/distributedAutonomousDatabases/{distributedAutonomousDatabaseId}/actions/changeDbBackupConfig".Trim('/')));
            HttpMethod method = new HttpMethod("POST");
            HttpRequestMessage requestMessage = Converter.ToHttpRequestMessage(uri, method, request);
            requestMessage.Headers.Add("Accept", "application/json");
            GenericRetrier retryingClient = Retrier.GetPreferredRetrier(retryConfiguration, this.retryConfiguration);
            ...
            try
            {
                ...
                {
                    ServiceName = "DistributedAutonomousDbService",
                    OperationName = "ChangeDistributedAutonomousDbBackupConfig",
                    RequestEndpoint = $"{method.Method} {requestMessage.RequestUri}",
                    ApiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/ChangeDistributedAutonomousDbBackupConfig",
                    UserAgent = this.GetUserAgent()
                };
                this.restClient.CheckHttpResponseMessage(requestMessage, responseMessage, apiDetails);
                logger.Debug($"Total Latency for this API call is: {stopWatch.ElapsedMilliseconds} ms");
                return Converter.FromHttpResponseMessage<ChangeDistributedAutonomousDbBackupConfigResponse>(responseMessage);
            }
            catch (OciException e)
            {
                logger.Error(e);
            ...
            {
                logger.Error($"ChangeDistributedAutonomousDbBackupConfig failed with error: {e.Message}");
                throw;
            }
        }
        ...
        /// <param name="completionOption">The completion option for this operation. Optional.</param>
        /// <returns>A response object containing details about the completed operation</returns>
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/distributeddatabasev26/ConfigureDistributedAutonomousDatabaseAutoResourceManagement.cs.html">here</a> to see an example of how to use ConfigureDistributedAutonomousDatabaseAutoResourceManagement API.</example>
        public async Task<ConfigureDistributedAutonomousDatabaseAutoResourceManagementResponse> ConfigureDistributedAutonomousDatabaseAutoResourceManagement(ConfigureDistributedAutonomousDatabaseAutoResourceManagementRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            logger.Trace("Called configureDistributedAutonomousDatabaseAutoResourceManagement");
            Uri uri = new Uri(this.restClient.GetEndpoint(), System.IO.Path.Combine(basePathWithoutHost, "/distributedAutonomousDatabases/{distributedAutonomousDatabaseId}/actions/configureAutoResourceManagement".Trim('/')));
            HttpMethod method = new HttpMethod("POST");
            HttpRequestMessage requestMessage = Converter.ToHttpRequestMessage(uri, method, request);
            requestMessage.Headers.Add("Accept", "application/json");
            GenericRetrier retryingClient = Retrier.GetPreferredRetrier(retryConfiguration, this.retryConfiguration);
            ...
            try
            {
                ...
                {
                    ServiceName = "DistributedAutonomousDbService",
                    OperationName = "ConfigureDistributedAutonomousDatabaseAutoResourceManagement",
                    RequestEndpoint = $"{method.Method} {requestMessage.RequestUri}",
                    ApiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/ConfigureDistributedAutonomousDatabaseAutoResourceManagement",
                    UserAgent = this.GetUserAgent()
                };
                this.restClient.CheckHttpResponseMessage(requestMessage, responseMessage, apiDetails);
                logger.Debug($"Total Latency for this API call is: {stopWatch.ElapsedMilliseconds} ms");
                return Converter.FromHttpResponseMessage<ConfigureDistributedAutonomousDatabaseAutoResourceManagementResponse>(responseMessage);
            }
            catch (OciException e)
            {
                logger.Error(e);
            ...
            {
                logger.Error($"ConfigureDistributedAutonomousDatabaseAutoResourceManagement failed with error: {e.Message}");
                throw;
            }
        }
        ...
        /// <param name="completionOption">The completion option for this operation. Optional.</param>
        /// <returns>A response object containing details about the completed operation</returns>
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/distributeddatabasev26/ConfigureDistributedAutonomousDatabaseGsmWallet.cs.html">here</a> to see an example of how to use ConfigureDistributedAutonomousDatabaseGsmWallet API.</example>
        public async Task<ConfigureDistributedAutonomousDatabaseGsmWalletResponse> ConfigureDistributedAutonomousDatabaseGsmWallet(ConfigureDistributedAutonomousDatabaseGsmWalletRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            try
            {
                ...
                ApiDetails apiDetails = new ApiDetails
                {
                    ...
                    RequestEndpoint = $"{method.Method} {requestMessage.RequestUri}",
                    ApiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/ConfigureDistributedAutonomousDatabaseGsmWallet",
                    UserAgent = this.GetUserAgent()
                };
                this.restClient.CheckHttpResponseMessage(requestMessage, responseMessage, apiDetails);
                logger.Debug($"Total Latency for this API call is: {stopWatch.ElapsedMilliseconds} ms");
        ...
        /// <param name="completionOption">The completion option for this operation. Optional.</param>
        /// <returns>A response object containing details about the completed operation</returns>
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/distributeddatabasev26/ConfigureDistributedAutonomousDatabaseGsms.cs.html">here</a> to see an example of how to use ConfigureDistributedAutonomousDatabaseGsms API.</example>
        public async Task<ConfigureDistributedAutonomousDatabaseGsmsResponse> ConfigureDistributedAutonomousDatabaseGsms(ConfigureDistributedAutonomousDatabaseGsmsRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            try
            {
                ...
                ApiDetails apiDetails = new ApiDetails
                {
                    ...
                    RequestEndpoint = $"{method.Method} {requestMessage.RequestUri}",
                    ApiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/ConfigureDistributedAutonomousDatabaseGsms",
                    UserAgent = this.GetUserAgent()
                };
                this.restClient.CheckHttpResponseMessage(requestMessage, responseMessage, apiDetails);
                logger.Debug($"Total Latency for this API call is: {stopWatch.ElapsedMilliseconds} ms");
        ...
        /// <param name="completionOption">The completion option for this operation. Optional.</param>
        /// <returns>A response object containing details about the completed operation</returns>
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/distributeddatabasev26/ConfigureDistributedAutonomousDatabaseSharding.cs.html">here</a> to see an example of how to use ConfigureDistributedAutonomousDatabaseSharding API.</example>
        public async Task<ConfigureDistributedAutonomousDatabaseShardingResponse> ConfigureDistributedAutonomousDatabaseSharding(ConfigureDistributedAutonomousDatabaseShardingRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            try
            {
                ...
                ApiDetails apiDetails = new ApiDetails
                {
                    ...
                    RequestEndpoint = $"{method.Method} {requestMessage.RequestUri}",
                    ApiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/ConfigureDistributedAutonomousDatabaseSharding",
                    UserAgent = this.GetUserAgent()
                };
                this.restClient.CheckHttpResponseMessage(requestMessage, responseMessage, apiDetails);
                logger.Debug($"Total Latency for this API call is: {stopWatch.ElapsedMilliseconds} ms");
        ...
        /// <param name="completionOption">The completion option for this operation. Optional.</param>
        /// <returns>A response object containing details about the completed operation</returns>
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/distributeddatabasev26/CreateDistributedAutonomousDatabase.cs.html">here</a> to see an example of how to use CreateDistributedAutonomousDatabase API.</example>
        ...
        /// <param name="completionOption">The completion option for this operation. Optional.</param>
        /// <returns>A response object containing details about the completed operation</returns>
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/distributeddatabasev26/DeleteDistributedAutonomousDatabase.cs.html">here</a> to see an example of how to use DeleteDistributedAutonomousDatabase API.</example>
        public async Task<DeleteDistributedAutonomousDatabaseResponse> DeleteDistributedAutonomousDatabase(DeleteDistributedAutonomousDatabaseRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            try
            {
                ...
                ApiDetails apiDetails = new ApiDetails
                {
                    ...
                    RequestEndpoint = $"{method.Method} {requestMessage.RequestUri}",
                    ApiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/DeleteDistributedAutonomousDatabase",
                    UserAgent = this.GetUserAgent()
                };
                this.restClient.CheckHttpResponseMessage(requestMessage, responseMessage, apiDetails);
                logger.Debug($"Total Latency for this API call is: {stopWatch.ElapsedMilliseconds} ms");
        ...
        /// <param name="completionOption">The completion option for this operation. Optional.</param>
        /// <returns>A response object containing details about the completed operation</returns>
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/distributeddatabasev26/GenerateDistributedAutonomousDatabaseWallet.cs.html">here</a> to see an example of how to use GenerateDistributedAutonomousDatabaseWallet API.</example>
        public async Task<GenerateDistributedAutonomousDatabaseWalletResponse> GenerateDistributedAutonomousDatabaseWallet(GenerateDistributedAutonomousDatabaseWalletRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            try
            {
                ...
                ApiDetails apiDetails = new ApiDetails
                {
                    ...
                    RequestEndpoint = $"{method.Method} {requestMessage.RequestUri}",
                    ApiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/GenerateDistributedAutonomousDatabaseWallet",
                    UserAgent = this.GetUserAgent()
                };
                this.restClient.CheckHttpResponseMessage(requestMessage, responseMessage, apiDetails);
                logger.Debug($"Total Latency for this API call is: {stopWatch.ElapsedMilliseconds} ms");
        ...
        /// <param name="completionOption">The completion option for this operation. Optional.</param>
        /// <returns>A response object containing details about the completed operation</returns>
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/distributeddatabasev26/GetDistributedAutonomousDatabase.cs.html">here</a> to see an example of how to use GetDistributedAutonomousDatabase API.</example>
        public async Task<GetDistributedAutonomousDatabaseResponse> GetDistributedAutonomousDatabase(GetDistributedAutonomousDatabaseRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            try
            {
                ...
                ApiDetails apiDetails = new ApiDetails
                {
                    ...
                    RequestEndpoint = $"{method.Method} {requestMessage.RequestUri}",
                    ApiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/GetDistributedAutonomousDatabase",
                    UserAgent = this.GetUserAgent()
                };
                this.restClient.CheckHttpResponseMessage(requestMessage, responseMessage, apiDetails);
                logger.Debug($"Total Latency for this API call is: {stopWatch.ElapsedMilliseconds} ms");
        ...
        /// <param name="completionOption">The completion option for this operation. Optional.</param>
        /// <returns>A response object containing details about the completed operation</returns>
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/distributeddatabasev26/GetDistributedAutonomousDatabaseRaftMetric.cs.html">here</a> to see an example of how to use GetDistributedAutonomousDatabaseRaftMetric API.</example>
        public async Task<GetDistributedAutonomousDatabaseRaftMetricResponse> GetDistributedAutonomousDatabaseRaftMetric(GetDistributedAutonomousDatabaseRaftMetricRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            try
            {
                ...
                ApiDetails apiDetails = new ApiDetails
                {
                    ...
                    RequestEndpoint = $"{method.Method} {requestMessage.RequestUri}",
                    ApiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabase/GetDistributedAutonomousDatabaseRaftMetric",
                    UserAgent = this.GetUserAgent()
                };
                this.restClient.CheckHttpResponseMessage(requestMessage, responseMessage, apiDetails);
                logger.Debug($"Total Latency for this API call is: {stopWatch.ElapsedMilliseconds} ms");
        ...
        /// <param name="completionOption">The completion option for this operation. Optional.</param>
        /// <returns>A response object containing details about the completed operation</returns>
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/distributeddatabasev26/GetDistributedAutonomousDatabaseRuChangeLog.cs.html">here</a> to see an example of how to use GetDistributedAutonomousDatabaseRuChangeLog API.</example>
        public async Task<GetDistributedAutonomousDatabaseRuChangeLogResponse> GetDistributedAutonomousDatabaseRuChangeLog(GetDistributedAutonomousDatabaseRuChangeLogRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            logger.Trace("Called getDistributedAutonomousDatabaseRuChangeLog");
            Uri uri = new Uri(this.restClient.GetEndpoint(), System.IO.Path.Combine(basePathWithoutHost, "/distributedAutonomousDatabases/{distributedAutonomousDatabaseId}/ruChangeLog".Trim('/')));
            HttpMethod method = new HttpMethod("GET");
            HttpRequestMessage requestMessage = Converter.ToHttpRequestMessage(uri, method, request);
            requestMessage.Headers.Add("Accept", "application/json");
            GenericRetrier retryingClient = Retrier.GetPreferredRetrier(retryConfiguration, this.retryConfiguration);
            ...
            try
            {
                ...
                {
                    ServiceName = "DistributedAutonomousDbService",
                    OperationName = "GetDistributedAutonomousDatabaseRuChangeLog",
                    RequestEndpoint = $"{method.Method} {requestMessage.RequestUri}",
                    ApiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabase/GetDistributedAutonomousDatabaseRuChangeLog",
                    UserAgent = this.GetUserAgent()
                };
                this.restClient.CheckHttpResponseMessage(requestMessage, responseMessage, apiDetails);
                logger.Debug($"Total Latency for this API call is: {stopWatch.ElapsedMilliseconds} ms");
                return Converter.FromHttpResponseMessage<GetDistributedAutonomousDatabaseRuChangeLogResponse>(responseMessage);
            }
            catch (OciException e)
            {
                logger.Error(e);
            ...
            {
                logger.Error($"GetDistributedAutonomousDatabaseRuChangeLog failed with error: {e.Message}");
                throw;
            }
        }
        ...
        /// <param name="completionOption">The completion option for this operation. Optional.</param>
        /// <returns>A response object containing details about the completed operation</returns>
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/distributeddatabasev26/ListDistributedAutonomousDatabases.cs.html">here</a> to see an example of how to use ListDistributedAutonomousDatabases API.</example>
        public async Task<ListDistributedAutonomousDatabasesResponse> ListDistributedAutonomousDatabases(ListDistributedAutonomousDatabasesRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            try
            {
                ...
                ApiDetails apiDetails = new ApiDetails
                {
                    ...
                    RequestEndpoint = $"{method.Method} {requestMessage.RequestUri}",
                    ApiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabaseCollection/ListDistributedAutonomousDatabases",
                    UserAgent = this.GetUserAgent()
                };
                this.restClient.CheckHttpResponseMessage(requestMessage, responseMessage, apiDetails);
                logger.Debug($"Total Latency for this API call is: {stopWatch.ElapsedMilliseconds} ms");
        ...
        /// <param name="completionOption">The completion option for this operation. Optional.</param>
        /// <returns>A response object containing details about the completed operation</returns>
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/distributeddatabasev26/MoveDistributedAutonomousDatabaseReplicationUnit.cs.html">here</a> to see an example of how to use MoveDistributedAutonomousDatabaseReplicationUnit API.</example>
        public async Task<MoveDistributedAutonomousDatabaseReplicationUnitResponse> MoveDistributedAutonomousDatabaseReplicationUnit(MoveDistributedAutonomousDatabaseReplicationUnitRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            try
            {
                ...
                ApiDetails apiDetails = new ApiDetails
                {
                    ...
                    RequestEndpoint = $"{method.Method} {requestMessage.RequestUri}",
                    ApiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/MoveDistributedAutonomousDatabaseReplicationUnit",
                    UserAgent = this.GetUserAgent()
                };
                this.restClient.CheckHttpResponseMessage(requestMessage, responseMessage, apiDetails);
                logger.Debug($"Total Latency for this API call is: {stopWatch.ElapsedMilliseconds} ms");
        ...
        /// <param name="completionOption">The completion option for this operation. Optional.</param>
        /// <returns>A response object containing details about the completed operation</returns>
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/distributeddatabasev26/PatchDistributedAutonomousDatabase.cs.html">here</a> to see an example of how to use PatchDistributedAutonomousDatabase API.</example>
        public async Task<PatchDistributedAutonomousDatabaseResponse> PatchDistributedAutonomousDatabase(PatchDistributedAutonomousDatabaseRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            try
            {
                ...
                ApiDetails apiDetails = new ApiDetails
                {
                    ...
                    RequestEndpoint = $"{method.Method} {requestMessage.RequestUri}",
                    ApiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/PatchDistributedAutonomousDatabase",
                    UserAgent = this.GetUserAgent()
                };
                this.restClient.CheckHttpResponseMessage(requestMessage, responseMessage, apiDetails);
                logger.Debug($"Total Latency for this API call is: {stopWatch.ElapsedMilliseconds} ms");
        ...
        /// <param name="completionOption">The completion option for this operation. Optional.</param>
        /// <returns>A response object containing details about the completed operation</returns>
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/distributeddatabasev26/RecreateFailedDistributedAutonomousDatabaseResource.cs.html">here</a> to see an example of how to use RecreateFailedDistributedAutonomousDatabaseResource API.</example>
        public async Task<RecreateFailedDistributedAutonomousDatabaseResourceResponse> RecreateFailedDistributedAutonomousDatabaseResource(RecreateFailedDistributedAutonomousDatabaseResourceRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            try
            {
                ...
                ApiDetails apiDetails = new ApiDetails
                {
                    ...
                    RequestEndpoint = $"{method.Method} {requestMessage.RequestUri}",
                    ApiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/RecreateFailedDistributedAutonomousDatabaseResource",
                    UserAgent = this.GetUserAgent()
                };
                this.restClient.CheckHttpResponseMessage(requestMessage, responseMessage, apiDetails);
                logger.Debug($"Total Latency for this API call is: {stopWatch.ElapsedMilliseconds} ms");
        ...
        /// <param name="completionOption">The completion option for this operation. Optional.</param>
        /// <returns>A response object containing details about the completed operation</returns>
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/distributeddatabasev26/RotateDistributedAutonomousDatabasePasswords.cs.html">here</a> to see an example of how to use RotateDistributedAutonomousDatabasePasswords API.</example>
        public async Task<RotateDistributedAutonomousDatabasePasswordsResponse> RotateDistributedAutonomousDatabasePasswords(RotateDistributedAutonomousDatabasePasswordsRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            try
            {
                ...
                ApiDetails apiDetails = new ApiDetails
                {
                    ...
                    RequestEndpoint = $"{method.Method} {requestMessage.RequestUri}",
                    ApiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/RotateDistributedAutonomousDatabasePasswords",
                    UserAgent = this.GetUserAgent()
                };
                this.restClient.CheckHttpResponseMessage(requestMessage, responseMessage, apiDetails);
                logger.Debug($"Total Latency for this API call is: {stopWatch.ElapsedMilliseconds} ms");
        ...
        /// <param name="completionOption">The completion option for this operation. Optional.</param>
        /// <returns>A response object containing details about the completed operation</returns>
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/distributeddatabasev26/ScaleDistributedAutonomousDatabaseGsms.cs.html">here</a> to see an example of how to use ScaleDistributedAutonomousDatabaseGsms API.</example>
        public async Task<ScaleDistributedAutonomousDatabaseGsmsResponse> ScaleDistributedAutonomousDatabaseGsms(ScaleDistributedAutonomousDatabaseGsmsRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            logger.Trace("Called scaleDistributedAutonomousDatabaseGsms");
            Uri uri = new Uri(this.restClient.GetEndpoint(), System.IO.Path.Combine(basePathWithoutHost, "/distributedAutonomousDatabases/{distributedAutonomousDatabaseId}/actions/scaleGsms".Trim('/')));
            HttpMethod method = new HttpMethod("POST");
            HttpRequestMessage requestMessage = Converter.ToHttpRequestMessage(uri, method, request);
            requestMessage.Headers.Add("Accept", "application/json");
            GenericRetrier retryingClient = Retrier.GetPreferredRetrier(retryConfiguration, this.retryConfiguration);
            ...
            try
            {
                ...
                {
                    ServiceName = "DistributedAutonomousDbService",
                    OperationName = "ScaleDistributedAutonomousDatabaseGsms",
                    RequestEndpoint = $"{method.Method} {requestMessage.RequestUri}",
                    ApiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/ScaleDistributedAutonomousDatabaseGsms",
                    UserAgent = this.GetUserAgent()
                };
                this.restClient.CheckHttpResponseMessage(requestMessage, responseMessage, apiDetails);
                logger.Debug($"Total Latency for this API call is: {stopWatch.ElapsedMilliseconds} ms");
                return Converter.FromHttpResponseMessage<ScaleDistributedAutonomousDatabaseGsmsResponse>(responseMessage);
            }
            catch (OciException e)
            {
                logger.Error(e);
            ...
            {
                logger.Error($"ScaleDistributedAutonomousDatabaseGsms failed with error: {e.Message}");
                throw;
            }
        }
        ...
        /// <param name="completionOption">The completion option for this operation. Optional.</param>
        /// <returns>A response object containing details about the completed operation</returns>
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/distributeddatabasev26/StartDistributedAutonomousDatabase.cs.html">here</a> to see an example of how to use StartDistributedAutonomousDatabase API.</example>
        public async Task<StartDistributedAutonomousDatabaseResponse> StartDistributedAutonomousDatabase(StartDistributedAutonomousDatabaseRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            try
            {
                ...
                ApiDetails apiDetails = new ApiDetails
                {
                    ...
                    RequestEndpoint = $"{method.Method} {requestMessage.RequestUri}",
                    ApiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/StartDistributedAutonomousDatabase",
                    UserAgent = this.GetUserAgent()
                };
                this.restClient.CheckHttpResponseMessage(requestMessage, responseMessage, apiDetails);
                logger.Debug($"Total Latency for this API call is: {stopWatch.ElapsedMilliseconds} ms");
        ...
        /// <param name="completionOption">The completion option for this operation. Optional.</param>
        /// <returns>A response object containing details about the completed operation</returns>
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/distributeddatabasev26/StopDistributedAutonomousDatabase.cs.html">here</a> to see an example of how to use StopDistributedAutonomousDatabase API.</example>
        public async Task<StopDistributedAutonomousDatabaseResponse> StopDistributedAutonomousDatabase(StopDistributedAutonomousDatabaseRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            try
            {
                ...
                ApiDetails apiDetails = new ApiDetails
                {
                    ...
                    RequestEndpoint = $"{method.Method} {requestMessage.RequestUri}",
                    ApiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/StopDistributedAutonomousDatabase",
                    UserAgent = this.GetUserAgent()
                };
                this.restClient.CheckHttpResponseMessage(requestMessage, responseMessage, apiDetails);
                logger.Debug($"Total Latency for this API call is: {stopWatch.ElapsedMilliseconds} ms");
        ...
        /// <param name="completionOption">The completion option for this operation. Optional.</param>
        /// <returns>A response object containing details about the completed operation</returns>
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/distributeddatabasev26/UpdateDistributedAutonomousDatabase.cs.html">here</a> to see an example of how to use UpdateDistributedAutonomousDatabase API.</example>
        public async Task<UpdateDistributedAutonomousDatabaseResponse> UpdateDistributedAutonomousDatabase(UpdateDistributedAutonomousDatabaseRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            try
            {
                ...
                ApiDetails apiDetails = new ApiDetails
                {
                    ...
                    RequestEndpoint = $"{method.Method} {requestMessage.RequestUri}",
                    ApiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/UpdateDistributedAutonomousDatabase",
                    UserAgent = this.GetUserAgent()
                };
                this.restClient.CheckHttpResponseMessage(requestMessage, responseMessage, apiDetails);
                logger.Debug($"Total Latency for this API call is: {stopWatch.ElapsedMilliseconds} ms");
        ...
        /// <param name="completionOption">The completion option for this operation. Optional.</param>
        /// <returns>A response object containing details about the completed operation</returns>
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/distributeddatabasev26/ValidateDistributedAutonomousDatabaseCaBundle.cs.html">here</a> to see an example of how to use ValidateDistributedAutonomousDatabaseCaBundle API.</example>
        public async Task<ValidateDistributedAutonomousDatabaseCaBundleResponse> ValidateDistributedAutonomousDatabaseCaBundle(ValidateDistributedAutonomousDatabaseCaBundleRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            try
            {
                ...
                ApiDetails apiDetails = new ApiDetails
                {
                    ...
                    RequestEndpoint = $"{method.Method} {requestMessage.RequestUri}",
                    ApiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/ValidateDistributedAutonomousDatabaseCaBundle",
                    UserAgent = this.GetUserAgent()
                };
                this.restClient.CheckHttpResponseMessage(requestMessage, responseMessage, apiDetails);
                logger.Debug($"Total Latency for this API call is: {stopWatch.ElapsedMilliseconds} ms");
        ...
        /// <param name="completionOption">The completion option for this operation. Optional.</param>
        /// <returns>A response object containing details about the completed operation</returns>
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/distributeddatabasev26/ValidateDistributedAutonomousDatabaseNetwork.cs.html">here</a> to see an example of how to use ValidateDistributedAutonomousDatabaseNetwork API.</example>
        public async Task<ValidateDistributedAutonomousDatabaseNetworkResponse> ValidateDistributedAutonomousDatabaseNetwork(ValidateDistributedAutonomousDatabaseNetworkRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            try
            {
                ...
                ApiDetails apiDetails = new ApiDetails
                {
                    ...
                    RequestEndpoint = $"{method.Method} {requestMessage.RequestUri}",
                    ApiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedAutonomousDatabase/ValidateDistributedAutonomousDatabaseNetwork",
                    UserAgent = this.GetUserAgent()
                };
                this.restClient.CheckHttpResponseMessage(requestMessage, responseMessage, apiDetails);
                logger.Debug($"Total Latency for this API call is: {stopWatch.ElapsedMilliseconds} ms");
