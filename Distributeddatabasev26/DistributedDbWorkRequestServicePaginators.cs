...
namespace Oci.Distributeddatabasev26Service
{
    ...
    /// to any list operations of DistributedDbWorkRequestService where multiple pages of data may be fetched.
    ...
    public class DistributedDbWorkRequestServicePaginators
    {
        ...
        public DistributedDbWorkRequestServicePaginators(DistributedDbWorkRequestServiceClient client)
        {
            this.client = client;
        }
