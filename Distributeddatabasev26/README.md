...
# OCI .NET client for Distributed Database V26 Service

This module enables you to write code to manage resources for Distributed Database V26 Service.
...
```
dotnet add package OCI.DotNetSDK.Distributeddatabasev26
```
