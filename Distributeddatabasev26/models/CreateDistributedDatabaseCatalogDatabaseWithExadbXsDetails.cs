...
{
    /// <summary>
    /// Configuration for creating a distributed database catalog using an existing ExaDB-XS VM cluster.
    /// </summary>
    public class CreateDistributedDatabaseCatalogDatabaseWithExadbXsDetails : CreateDistributedDatabaseCatalogDatabaseDetails
    {
        ...
        private readonly string source = "XS_EXISTING_CLUSTER";
    }
}
