...
{
    /// <summary>
    /// Details of a distributed database catalog on ExaDB-XS with a new cluster.
    /// </summary>
    public class DistributedDatabaseCatalogDatabaseWithExadbXsNewCluster : DistributedDatabaseCatalogDatabase
    {
