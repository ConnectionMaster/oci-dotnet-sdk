...
{
    /// <summary>
    /// Details of a distributed database shard on ExaDB-XS with a new cluster.
    /// </summary>
    public class DistributedDatabaseShardDatabaseWithExadbXsNewCluster : DistributedDatabaseShardDatabase
    {
