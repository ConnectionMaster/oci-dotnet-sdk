...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/oda/UpdateSkill.cs.html">here</a> to see an example of how to use UpdateSkill request.
    /// </example>
    public class UpdateSkillRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UpdateSkillDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public UpdateSkillDetails UpdateSkillDetails { get; set; }
