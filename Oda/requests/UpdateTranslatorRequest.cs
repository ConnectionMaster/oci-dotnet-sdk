...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/oda/UpdateTranslator.cs.html">here</a> to see an example of how to use UpdateTranslator request.
    /// </example>
    public class UpdateTranslatorRequest : Oci.Common.IOciRequest
    {
        ...
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "translatorId")]
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UpdateTranslatorDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public UpdateTranslatorDetails UpdateTranslatorDetails { get; set; }
