...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/waas/UpdateWaasPolicyCustomProtectionRules.cs.html">here</a> to see an example of how to use UpdateWaasPolicyCustomProtectionRules request.
    /// </example>
    public class UpdateWaasPolicyCustomProtectionRulesRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UpdateCustomProtectionRulesDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public System.Collections.Generic.List<CustomProtectionRuleSetting> UpdateCustomProtectionRulesDetails { get; set; }
