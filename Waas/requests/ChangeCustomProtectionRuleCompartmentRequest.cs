...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/waas/ChangeCustomProtectionRuleCompartment.cs.html">here</a> to see an example of how to use ChangeCustomProtectionRuleCompartment request.
    /// </example>
    public class ChangeCustomProtectionRuleCompartmentRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "CustomProtectionRuleId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "customProtectionRuleId")]
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "ChangeCustomProtectionRuleCompartmentDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public ChangeCustomProtectionRuleCompartmentDetails ChangeCustomProtectionRuleCompartmentDetails { get; set; }
