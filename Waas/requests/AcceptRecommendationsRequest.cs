...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/waas/AcceptRecommendations.cs.html">here</a> to see an example of how to use AcceptRecommendations request.
    /// </example>
    public class AcceptRecommendationsRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "ProtectionRuleKeys is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public System.Collections.Generic.List<string> ProtectionRuleKeys { get; set; }
