...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/waas/DeleteHttpRedirect.cs.html">here</a> to see an example of how to use DeleteHttpRedirect request.
    /// </example>
    public class DeleteHttpRedirectRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "HttpRedirectId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "httpRedirectId")]
