...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/waas/GetProtectionRule.cs.html">here</a> to see an example of how to use GetProtectionRule request.
    /// </example>
    public class GetProtectionRuleRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "ProtectionRuleKey is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "protectionRuleKey")]
