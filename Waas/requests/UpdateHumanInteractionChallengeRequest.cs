...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/waas/UpdateHumanInteractionChallenge.cs.html">here</a> to see an example of how to use UpdateHumanInteractionChallenge request.
    /// </example>
    public class UpdateHumanInteractionChallengeRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UpdateHumanInteractionChallengeDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public HumanInteractionChallenge UpdateHumanInteractionChallengeDetails { get; set; }
