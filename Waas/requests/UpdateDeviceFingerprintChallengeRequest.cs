...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/waas/UpdateDeviceFingerprintChallenge.cs.html">here</a> to see an example of how to use UpdateDeviceFingerprintChallenge request.
    /// </example>
    public class UpdateDeviceFingerprintChallengeRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UpdateDeviceFingerprintChallengeDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public DeviceFingerprintChallenge UpdateDeviceFingerprintChallengeDetails { get; set; }
