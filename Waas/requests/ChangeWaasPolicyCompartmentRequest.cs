...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/waas/ChangeWaasPolicyCompartment.cs.html">here</a> to see an example of how to use ChangeWaasPolicyCompartment request.
    /// </example>
    public class ChangeWaasPolicyCompartmentRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "ChangeWaasPolicyCompartmentDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public ChangeWaasPolicyCompartmentDetails ChangeWaasPolicyCompartmentDetails { get; set; }
