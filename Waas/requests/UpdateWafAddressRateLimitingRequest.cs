...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/waas/UpdateWafAddressRateLimiting.cs.html">here</a> to see an example of how to use UpdateWafAddressRateLimiting request.
    /// </example>
    public class UpdateWafAddressRateLimitingRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UpdateWafAddressRateLimitingDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public AddressRateLimiting UpdateWafAddressRateLimitingDetails { get; set; }
