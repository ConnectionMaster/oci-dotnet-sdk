...
{
    public class ListSensitiveColumnAnalyticsResponse : Oci.Common.OciResponse
    {
        ...
        public SensitiveColumnAnalyticsCollection SensitiveColumnAnalyticsCollection { get; set; }
