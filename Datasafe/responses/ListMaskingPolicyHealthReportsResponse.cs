...
{
    public class ListMaskingPolicyHealthReportsResponse : Oci.Common.OciResponse
    {
        ...
        public MaskingPolicyHealthReportCollection MaskingPolicyHealthReportCollection { get; set; }
