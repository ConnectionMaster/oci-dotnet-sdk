...
{
    public class CreateTargetAlertPolicyAssociationResponse : Oci.Common.OciResponse
    {
        ...
        public TargetAlertPolicyAssociation TargetAlertPolicyAssociation { get; set; }
