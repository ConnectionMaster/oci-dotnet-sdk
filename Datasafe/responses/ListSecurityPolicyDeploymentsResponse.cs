...
{
    public class ListSecurityPolicyDeploymentsResponse : Oci.Common.OciResponse
    {
        ...
        public SecurityPolicyDeploymentCollection SecurityPolicyDeploymentCollection { get; set; }
