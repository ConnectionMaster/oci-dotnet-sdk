...
{
    public class ListDatabaseViewAccessEntriesResponse : Oci.Common.OciResponse
    {
        ...
        public DatabaseViewAccessEntryCollection DatabaseViewAccessEntryCollection { get; set; }
