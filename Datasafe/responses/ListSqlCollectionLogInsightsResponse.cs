...
{
    public class ListSqlCollectionLogInsightsResponse : Oci.Common.OciResponse
    {
        ...
        public SqlCollectionLogInsightsCollection SqlCollectionLogInsightsCollection { get; set; }
