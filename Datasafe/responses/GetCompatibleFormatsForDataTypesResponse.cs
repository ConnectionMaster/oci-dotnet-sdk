...
{
    public class GetCompatibleFormatsForDataTypesResponse : Oci.Common.OciResponse
    {
        ...
        public CompatibleFormatsForDataTypes CompatibleFormatsForDataTypes { get; set; }
