...
{
    public class ListMaskingPolicyHealthReportLogsResponse : Oci.Common.OciResponse
    {
        ...
        public MaskingPolicyHealthReportLogCollection MaskingPolicyHealthReportLogCollection { get; set; }
