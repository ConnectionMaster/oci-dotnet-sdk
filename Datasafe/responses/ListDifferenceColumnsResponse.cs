...
{
    public class ListDifferenceColumnsResponse : Oci.Common.OciResponse
    {
        ...
        public SdmMaskingPolicyDifferenceColumnCollection SdmMaskingPolicyDifferenceColumnCollection { get; set; }
