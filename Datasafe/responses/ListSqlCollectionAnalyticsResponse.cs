...
{
    public class ListSqlCollectionAnalyticsResponse : Oci.Common.OciResponse
    {
        ...
        public SqlCollectionAnalyticsCollection SqlCollectionAnalyticsCollection { get; set; }
