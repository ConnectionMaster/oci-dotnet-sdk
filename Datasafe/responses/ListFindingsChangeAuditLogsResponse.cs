...
{
    public class ListFindingsChangeAuditLogsResponse : Oci.Common.OciResponse
    {
        ...
        public FindingsChangeAuditLogCollection FindingsChangeAuditLogCollection { get; set; }
