...
{
    public class GetCompatibleFormatsForSensitiveTypesResponse : Oci.Common.OciResponse
    {
        ...
        public CompatibleFormatsForSensitiveTypes CompatibleFormatsForSensitiveTypes { get; set; }
