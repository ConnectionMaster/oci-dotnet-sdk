...
{
    public class ListMaskingPolicyReferentialRelationsResponse : Oci.Common.OciResponse
    {
        ...
        public MaskingPolicyReferentialRelationCollection MaskingPolicyReferentialRelationCollection { get; set; }
