...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/datasafe/ListCollectedAuditVolumes.cs.html">here</a> to see an example of how to use ListCollectedAuditVolumes request.
    /// </example>
    public class ListCollectedAuditVolumesRequest : Oci.Common.IOciRequest
    {
        ...
        public enum SortByEnum {
            ...
            [EnumMember(Value = "onlineVolume")]
            OnlineVolume,
            [EnumMember(Value = "archivedVolume")]
            ArchivedVolume
        };
