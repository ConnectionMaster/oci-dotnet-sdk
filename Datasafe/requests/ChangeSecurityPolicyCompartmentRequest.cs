...
namespace Oci.DatasafeService.Requests
{
    ...
    public class ChangeSecurityPolicyCompartmentRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "ChangeSecurityPolicyCompartmentDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public ChangeSecurityPolicyCompartmentDetails ChangeSecurityPolicyCompartmentDetails { get; set; }
