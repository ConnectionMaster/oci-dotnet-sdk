...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/datasafe/ListSqlFirewallPolicies.cs.html">here</a> to see an example of how to use ListSqlFirewallPolicies request.
    /// </example>
    public class ListSqlFirewallPoliciesRequest : Oci.Common.IOciRequest
    {
        ...
        /// An optional filter to return only resources that match the specified violation action.
        /// </value>
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "violationAction")]
