...
namespace Oci.DatasafeService.Requests
{
    ...
    public class UpdateSecurityPolicyDeploymentRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UpdateSecurityPolicyDeploymentDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public UpdateSecurityPolicyDeploymentDetails UpdateSecurityPolicyDeploymentDetails { get; set; }
