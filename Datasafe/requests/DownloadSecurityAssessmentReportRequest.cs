...
namespace Oci.DatasafeService.Requests
{
    ...
    public class DownloadSecurityAssessmentReportRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "DownloadSecurityAssessmentReportDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public DownloadSecurityAssessmentReportDetails DownloadSecurityAssessmentReportDetails { get; set; }
