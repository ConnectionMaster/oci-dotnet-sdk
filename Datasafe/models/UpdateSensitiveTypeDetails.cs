...
namespace Oci.DatasafeService.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(UpdateSensitiveTypeDetailsModelConverter))]
    ...
    public class UpdateSensitiveTypeDetailsModelConverter : JsonConverter
    {
        public override bool CanWrite => false;
        public override bool CanRead => true;
        public override bool CanConvert(System.Type type)
        {
            return type == typeof(UpdateSensitiveTypeDetails);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(UpdateSensitiveTypeDetails);
            var discriminator = jsonObject["entityType"].Value<string>();
            switch (discriminator)
            {
                case "SENSITIVE_CATEGORY":
                    obj = new UpdateSensitiveCategoryDetails();
                    break;
                case "SENSITIVE_TYPE":
                    obj = new UpdateSensitiveTypePatternDetails();
                    break;
            }
