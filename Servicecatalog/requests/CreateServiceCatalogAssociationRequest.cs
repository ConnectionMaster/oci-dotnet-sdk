...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/servicecatalog/CreateServiceCatalogAssociation.cs.html">here</a> to see an example of how to use CreateServiceCatalogAssociation request.
    /// </example>
    public class CreateServiceCatalogAssociationRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "CreateServiceCatalogAssociationDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public CreateServiceCatalogAssociationDetails CreateServiceCatalogAssociationDetails { get; set; }
