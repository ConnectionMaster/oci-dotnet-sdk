...
namespace Oci.GenerativeaidataService
{
    ...
    /// to any list operations of EnrichmentJob where multiple pages of data may be fetched.
    ...
    /// </summary>
    public class EnrichmentJobPaginators
    {
        private readonly EnrichmentJobClient client;

        public EnrichmentJobPaginators(EnrichmentJobClient client)
        {
            this.client = client;
        }
