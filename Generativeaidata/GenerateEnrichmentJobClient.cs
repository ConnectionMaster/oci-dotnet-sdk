...
{
    /// <summary>Service client instance for GenerateEnrichmentJob.</summary>
    public class GenerateEnrichmentJobClient : RegionalClientBase
    {
        ...
        public GenerateEnrichmentJobClient(IBasicAuthenticationDetailsProvider authenticationDetailsProvider, ClientConfiguration clientConfiguration = null, string endpoint = null)
            : base(authenticationDetailsProvider, clientConfiguration)
        {
            ...
            service = new Service
            {
                ServiceName = "GENERATEENRICHMENTJOB",
