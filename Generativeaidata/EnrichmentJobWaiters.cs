...
{
    /// <summary>
    /// Contains collection of helper methods to produce Oci.Common.Waiters for different resources of EnrichmentJob.
    /// </summary>
    public class EnrichmentJobWaiters
    {
        private readonly EnrichmentJobClient client;

        public  EnrichmentJobWaiters(EnrichmentJobClient client)
        {
            this.client = client;
        }
