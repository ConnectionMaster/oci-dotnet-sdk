...
# OCI .NET client for Cluster Health Service

This module enables you to write code to manage resources for Cluster Health Service.
...
```
dotnet add package OCI.DotNetSDK.Clusterhealth
```
