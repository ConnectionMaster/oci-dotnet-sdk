...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/rover/ListRoverClusterRoverBundleRequests.cs.html">here</a> to see an example of how to use ListRoverClusterRoverBundleRequests request.
    /// </example>
    public class ListRoverClusterRoverBundleRequestsRequest : Oci.Common.IOciRequest
    {
        ...
        public enum SortByEnum {
            [EnumMember(Value = "timeTaskCreated")]
            TimeTaskCreated
        };
