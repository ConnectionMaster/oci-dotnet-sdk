...
namespace Oci.RoverService
{
    ...
    public class ShapeClient : RegionalClientBase
    {
        ...
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/rover/ListShapes.cs.html">here</a> to see an example of how to use ListShapes API.</example>
