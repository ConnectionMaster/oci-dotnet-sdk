...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/usage/DeleteRedeemableUser.cs.html">here</a> to see an example of how to use DeleteRedeemableUser request.
    /// </example>
    public class DeleteRedeemableUserRequest : Oci.Common.IOciRequest
    {
        ...
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "emailId")]
