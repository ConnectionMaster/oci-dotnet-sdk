...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/fleetsoftwareupdate/ListFsuActions.cs.html">here</a> to see an example of how to use ListFsuActions request.
    /// </example>
    public class ListFsuActionsRequest : Oci.Common.IOciRequest
    {
        ...
        /// 
        /// </value>
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "fsuCycleId")]
        ...
        public System.Nullable<ActionLifecycleStates> LifecycleState { get; set; }
        ...
        public System.Nullable<ActionTypes> Type { get; set; }
