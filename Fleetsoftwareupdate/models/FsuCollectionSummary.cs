...
namespace Oci.FleetsoftwareupdateService.Models
{
    ...
    /// 
    /// </summary>
    [JsonConverter(typeof(FsuCollectionSummaryModelConverter))]
    public class FsuCollectionSummary 
    {
    ...
    public class FsuCollectionSummaryModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(FsuCollectionSummary);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(FsuCollectionSummary);
            ...
            {
                logger.Warn($"The type {discriminator} is not present under FsuCollectionSummary! Returning null value.");
            }
            return obj;
        }
    }
