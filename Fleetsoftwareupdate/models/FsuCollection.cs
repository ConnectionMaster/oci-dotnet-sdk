...
namespace Oci.FleetsoftwareupdateService.Models
{
    ...
    /// 
    /// </summary>
    [JsonConverter(typeof(FsuCollectionModelConverter))]
    public class FsuCollection 
    {
        ...
        [JsonProperty(PropertyName = "activeFsuCycle")]
        public ActiveCycleDetails ActiveFsuCycle { get; set; }
    ...
    public class FsuCollectionModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(FsuCollection);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(FsuCollection);
            var discriminator = jsonObject["type"].Value<string>();
            switch (discriminator)
            {
                case "GUEST_OS":
                    obj = new GuestOsCollection();
                    break;
                case "EXADB_STACK":
                    obj = new ExadbStackCollection();
                    break;
                case "GI":
                    obj = new GiCollection();
                    break;
                case "DB":
                    obj = new DbCollection();
                    break;
            }
            if (obj != null)
            {
            ...
            {
                logger.Warn($"The type {discriminator} is not present under FsuCollection! Returning null value.");
            }
            return obj;
        }
    }
