...
namespace Oci.DnsService.Models
{
    ...
    public class ResolverEndpointModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(ResolverEndpoint);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(ResolverEndpoint);
            var discriminator = jsonObject["endpointType"].Value<string>();
            switch (discriminator)
            {
                case "VNIC":
                    obj = new ResolverVnicEndpoint();
                    break;
            }
            if (obj != null)
            {
            ...
            {
                logger.Warn($"The type {discriminator} is not present under ResolverEndpoint! Returning null value.");
            }
            return obj;
        }
    }
