...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/dns/GetDomainRecords.cs.html">here</a> to see an example of how to use GetDomainRecords request.
    /// </example>
    public class GetDomainRecordsRequest : Oci.Common.IOciRequest
    {
