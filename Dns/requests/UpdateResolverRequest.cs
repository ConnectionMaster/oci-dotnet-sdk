...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/dns/UpdateResolver.cs.html">here</a> to see an example of how to use UpdateResolver request.
    /// </example>
    public class UpdateResolverRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UpdateResolverDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public UpdateResolverDetails UpdateResolverDetails { get; set; }
