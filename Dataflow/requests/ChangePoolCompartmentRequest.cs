...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/dataflow/ChangePoolCompartment.cs.html">here</a> to see an example of how to use ChangePoolCompartment request.
    /// </example>
    public class ChangePoolCompartmentRequest : Oci.Common.IOciRequest
    {
        ...
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "poolId")]
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "ChangePoolCompartmentDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public ChangePoolCompartmentDetails ChangePoolCompartmentDetails { get; set; }
