...
{
    public class RequestSummarizedJavaDownloadCountsResponse : Oci.Common.OciResponse
    {
        ...
        public JavaDownloadCountAggregationCollection JavaDownloadCountAggregationCollection { get; set; }
