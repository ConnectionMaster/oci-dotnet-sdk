...
namespace Oci.BatchService.Models
{
    ...
    /// 
    /// </summary>
    public class CreateBatchContextDetails 
    {
        ...
        /// </value>
        [JsonProperty(PropertyName = "jobPriorityConfigurations")]
        public System.Collections.Generic.List<JobPriorityConfiguration> JobPriorityConfigurations { get; set; }
        ...
        public CreateNetworkDetails Network { get; set; }
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "Fleets is required.")]
        [JsonProperty(PropertyName = "fleets")]
        public System.Collections.Generic.List<CreateFleetDetails> Fleets { get; set; }
