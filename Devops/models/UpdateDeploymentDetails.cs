...
namespace Oci.DevopsService.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(UpdateDeploymentDetailsModelConverter))]
    ...
    public class UpdateDeploymentDetailsModelConverter : JsonConverter
    {
        public override bool CanWrite => false;
        public override bool CanRead => true;
        public override bool CanConvert(System.Type type)
        {
            return type == typeof(UpdateDeploymentDetails);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(UpdateDeploymentDetails);
            var discriminator = jsonObject["deploymentType"].Value<string>();
            switch (discriminator)
            {
                case "SINGLE_STAGE_DEPLOYMENT":
                    obj = new UpdateSingleDeployStageDeploymentDetails();
                    break;
                case "PIPELINE_REDEPLOYMENT":
                    obj = new UpdateDeployPipelineRedeploymentDetails();
                    break;
