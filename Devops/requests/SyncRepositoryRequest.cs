...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/devops/SyncRepository.cs.html">here</a> to see an example of how to use SyncRepository request.
    /// </example>
    public class SyncRepositoryRequest : Oci.Common.IOciRequest
    {
        ...
        /// </value>
        ///
        public enum SyncMergeStrategyEnum {
            [EnumMember(Value = "FETCH_AND_MERGE")]
            FetchAndMerge,
        ...
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "syncMergeStrategy")]
        public System.Nullable<SyncMergeStrategyEnum> SyncMergeStrategy { get; set; }
