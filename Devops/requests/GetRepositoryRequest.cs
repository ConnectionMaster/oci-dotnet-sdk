...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/devops/GetRepository.cs.html">here</a> to see an example of how to use GetRepository request.
    /// </example>
    public class GetRepositoryRequest : Oci.Common.IOciRequest
    {
        ...
        public enum FieldsEnum {
            [EnumMember(Value = "branchCount")]
            BranchCount,
            [EnumMember(Value = "commitCount")]
            CommitCount,
