...
namespace Oci.CoreService.Models
{
    ...
    public class PatchSubnetInstructionModelConverter : JsonConverter
    {
        public override bool CanWrite => false;
        public override bool CanRead => true;
        public override bool CanConvert(System.Type type)
        {
            return type == typeof(PatchSubnetInstruction);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(PatchSubnetInstruction);
            var discriminator = jsonObject["operation"].Value<string>();
            switch (discriminator)
            {
                case "REPLACE":
                    obj = new PatchSubnetReplaceInstruction();
                    break;
            }
