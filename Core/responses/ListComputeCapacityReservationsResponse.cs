...
{
    public class ListComputeCapacityReservationsResponse : Oci.Common.OciResponse
    {
        ...
        public System.Collections.Generic.List<ComputeCapacityReservationSummary> Items { get; set; }
