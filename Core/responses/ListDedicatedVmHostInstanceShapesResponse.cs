...
{
    public class ListDedicatedVmHostInstanceShapesResponse : Oci.Common.OciResponse
    {
        ...
        public System.Collections.Generic.List<DedicatedVmHostInstanceShapeSummary> Items { get; set; }
