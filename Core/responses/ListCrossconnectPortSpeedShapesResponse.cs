...
{
    public class ListCrossconnectPortSpeedShapesResponse : Oci.Common.OciResponse
    {
        ...
        public System.Collections.Generic.List<CrossConnectPortSpeedShape> Items { get; set; }
