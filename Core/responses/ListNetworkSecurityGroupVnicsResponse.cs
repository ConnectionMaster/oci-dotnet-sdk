...
{
    public class ListNetworkSecurityGroupVnicsResponse : Oci.Common.OciResponse
    {
        ...
        public System.Collections.Generic.List<NetworkSecurityGroupVnic> Items { get; set; }
