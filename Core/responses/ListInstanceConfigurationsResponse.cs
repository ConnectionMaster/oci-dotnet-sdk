...
{
    public class ListInstanceConfigurationsResponse : Oci.Common.OciResponse
    {
        ...
        public System.Collections.Generic.List<InstanceConfigurationSummary> Items { get; set; }
