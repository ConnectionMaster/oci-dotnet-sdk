...
{
    public class ListComputeCapacityTopologyComputeHpcIslandsResponse : Oci.Common.OciResponse
    {
        ...
        public ComputeHpcIslandCollection ComputeHpcIslandCollection { get; set; }
