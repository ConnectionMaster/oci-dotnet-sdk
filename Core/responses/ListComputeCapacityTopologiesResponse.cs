...
{
    public class ListComputeCapacityTopologiesResponse : Oci.Common.OciResponse
    {
        ...
        public ComputeCapacityTopologyCollection ComputeCapacityTopologyCollection { get; set; }
