...
{
    public class ListDrgRouteDistributionStatementsResponse : Oci.Common.OciResponse
    {
        ...
        public System.Collections.Generic.List<DrgRouteDistributionStatement> Items { get; set; }
