...
{
    public class ListInstanceConsoleConnectionsResponse : Oci.Common.OciResponse
    {
        ...
        public System.Collections.Generic.List<InstanceConsoleConnection> Items { get; set; }
