...
{
    public class ListComputeImageCapabilitySchemasResponse : Oci.Common.OciResponse
    {
        ...
        public System.Collections.Generic.List<ComputeImageCapabilitySchemaSummary> Items { get; set; }
