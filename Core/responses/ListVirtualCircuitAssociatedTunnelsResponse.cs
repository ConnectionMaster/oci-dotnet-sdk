...
{
    public class ListVirtualCircuitAssociatedTunnelsResponse : Oci.Common.OciResponse
    {
        ...
        public System.Collections.Generic.List<VirtualCircuitAssociatedTunnelDetails> Items { get; set; }
