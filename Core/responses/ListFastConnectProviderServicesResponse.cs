...
{
    public class ListFastConnectProviderServicesResponse : Oci.Common.OciResponse
    {
        ...
        public System.Collections.Generic.List<FastConnectProviderService> Items { get; set; }
