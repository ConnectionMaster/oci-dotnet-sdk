...
{
    public class ListInstanceMaintenanceEventsResponse : Oci.Common.OciResponse
    {
        ...
        public System.Collections.Generic.List<InstanceMaintenanceEventSummary> Items { get; set; }
