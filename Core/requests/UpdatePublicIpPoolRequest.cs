...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/core/UpdatePublicIpPool.cs.html">here</a> to see an example of how to use UpdatePublicIpPool request.
    /// </example>
    public class UpdatePublicIpPoolRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UpdatePublicIpPoolDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public UpdatePublicIpPoolDetails UpdatePublicIpPoolDetails { get; set; }
