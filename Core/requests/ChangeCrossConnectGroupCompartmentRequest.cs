...
namespace Oci.CoreService.Requests
{
    ...
    public class ChangeCrossConnectGroupCompartmentRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "ChangeCrossConnectGroupCompartmentDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public ChangeCrossConnectGroupCompartmentDetails ChangeCrossConnectGroupCompartmentDetails { get; set; }
