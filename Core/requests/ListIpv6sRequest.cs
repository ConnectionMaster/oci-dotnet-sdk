...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/core/ListIpv6s.cs.html">here</a> to see an example of how to use ListIpv6s request.
    /// </example>
