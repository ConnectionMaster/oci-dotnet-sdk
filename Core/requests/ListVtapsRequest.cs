...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/core/ListVtaps.cs.html">here</a> to see an example of how to use ListVtaps request.
    /// </example>
    public class ListVtapsRequest : Oci.Common.IOciRequest
    {
        ...
        /// </value>
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "targetIp")]
        ...
        /// 
        /// </value>
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "isVtapEnabled")]
        ...
        public System.Nullable<Vtap.LifecycleStateEnum> LifecycleState { get; set; }
    }
}
