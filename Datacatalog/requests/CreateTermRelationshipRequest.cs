...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/datacatalog/CreateTermRelationship.cs.html">here</a> to see an example of how to use CreateTermRelationship request.
    /// </example>
    public class CreateTermRelationshipRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "CreateTermRelationshipDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public CreateTermRelationshipDetails CreateTermRelationshipDetails { get; set; }
