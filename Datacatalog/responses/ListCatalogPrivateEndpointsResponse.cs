...
{
    public class ListCatalogPrivateEndpointsResponse : Oci.Common.OciResponse
    {
        ...
        public System.Collections.Generic.List<CatalogPrivateEndpointSummary> Items { get; set; }
