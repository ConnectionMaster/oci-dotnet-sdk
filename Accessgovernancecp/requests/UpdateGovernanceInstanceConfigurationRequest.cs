...
namespace Oci.AccessgovernancecpService.Requests
{
    ...
    public class UpdateGovernanceInstanceConfigurationRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UpdateGovernanceInstanceConfigurationDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public UpdateGovernanceInstanceConfigurationDetails UpdateGovernanceInstanceConfigurationDetails { get; set; }
