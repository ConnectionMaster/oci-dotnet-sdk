...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/stackmonitoring/TestMetricExtension.cs.html">here</a> to see an example of how to use TestMetricExtension request.
    /// </example>
    public class TestMetricExtensionRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "TestMetricExtensionDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public TestMetricExtensionDetails TestMetricExtensionDetails { get; set; }
