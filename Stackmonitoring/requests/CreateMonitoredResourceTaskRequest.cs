...
namespace Oci.StackmonitoringService.Requests
{
    ...
    public class CreateMonitoredResourceTaskRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "CreateMonitoredResourceTaskDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public CreateMonitoredResourceTaskDetails CreateMonitoredResourceTaskDetails { get; set; }
