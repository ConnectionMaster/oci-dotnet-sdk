...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/cloudbridge/ChangeAssetSourceCompartment.cs.html">here</a> to see an example of how to use ChangeAssetSourceCompartment request.
    /// </example>
    public class ChangeAssetSourceCompartmentRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "AssetSourceId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "assetSourceId")]
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "ChangeAssetSourceCompartmentDetails is required.")]
