...
namespace Oci.ApigatewayService
{
    ...
    public class UsagePlansClient : RegionalClientBase
    {
        ...
        public async Task<AddUsagePlanLockResponse> AddUsagePlanLock(AddUsagePlanLockRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            Uri uri = new Uri(this.restClient.GetEndpoint(), System.IO.Path.Combine(basePathWithoutHost, "/usagePlans/{usagePlanId}/actions/addLock".Trim('/')));
            ...
            try
            {
                ...
                {
                    ServiceName = "UsagePlans",
                    OperationName = "AddUsagePlanLock",
                ...
                return Converter.FromHttpResponseMessage<AddUsagePlanLockResponse>(responseMessage);
            }
            ...
            {
                logger.Error($"AddUsagePlanLock failed with error: {e.Message}");
                throw;
            }
        }
        ...
        public async Task<RemoveUsagePlanLockResponse> RemoveUsagePlanLock(RemoveUsagePlanLockRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            Uri uri = new Uri(this.restClient.GetEndpoint(), System.IO.Path.Combine(basePathWithoutHost, "/usagePlans/{usagePlanId}/actions/removeLock".Trim('/')));
            HttpMethod method = new HttpMethod("POST");
            HttpRequestMessage requestMessage = Converter.ToHttpRequestMessage(uri, method, request);
            requestMessage.Headers.Add("Accept", "application/json");
            GenericRetrier retryingClient = Retrier.GetPreferredRetrier(retryConfiguration, this.retryConfiguration);
            ...
            try
            {
                ...
                {
                    ServiceName = "UsagePlans",
                    OperationName = "RemoveUsagePlanLock",
                    RequestEndpoint = $"{method.Method} {requestMessage.RequestUri}",
                ...
                this.restClient.CheckHttpResponseMessage(requestMessage, responseMessage, apiDetails);
                logger.Debug($"Total Latency for this API call is: {stopWatch.ElapsedMilliseconds} ms");
                return Converter.FromHttpResponseMessage<RemoveUsagePlanLockResponse>(responseMessage);
            }
            catch (OciException e)
            {
                logger.Error(e);
            ...
            {
                logger.Error($"RemoveUsagePlanLock failed with error: {e.Message}");
                throw;
            }
        }
