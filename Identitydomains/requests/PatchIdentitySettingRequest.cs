...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/PatchIdentitySetting.cs.html">here</a> to see an example of how to use PatchIdentitySetting request.
    /// </example>
    public class PatchIdentitySettingRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "IdentitySettingId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "identitySettingId")]
