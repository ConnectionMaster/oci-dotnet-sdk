...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/PatchMyPendingApproval.cs.html">here</a> to see an example of how to use PatchMyPendingApproval request.
    /// </example>
    public class PatchMyPendingApprovalRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "MyPendingApprovalId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "myPendingApprovalId")]
        public string MyPendingApprovalId { get; set; }
