...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/PatchMyCustomerSecretKey.cs.html">here</a> to see an example of how to use PatchMyCustomerSecretKey request.
    /// </example>
    public class PatchMyCustomerSecretKeyRequest : Oci.Common.IOciRequest
    {
