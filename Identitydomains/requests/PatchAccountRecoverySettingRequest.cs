...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/PatchAccountRecoverySetting.cs.html">here</a> to see an example of how to use PatchAccountRecoverySetting request.
    /// </example>
    public class PatchAccountRecoverySettingRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "AccountRecoverySettingId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "accountRecoverySettingId")]
