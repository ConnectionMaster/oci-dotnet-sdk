...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/PatchSchema.cs.html">here</a> to see an example of how to use PatchSchema request.
    /// </example>
    public class PatchSchemaRequest : Oci.Common.IOciRequest
    {
        ...
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "schemaId")]
