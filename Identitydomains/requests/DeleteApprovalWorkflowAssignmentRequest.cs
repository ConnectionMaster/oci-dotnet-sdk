...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/DeleteApprovalWorkflowAssignment.cs.html">here</a> to see an example of how to use DeleteApprovalWorkflowAssignment request.
    /// </example>
    public class DeleteApprovalWorkflowAssignmentRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "ApprovalWorkflowAssignmentId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "approvalWorkflowAssignmentId")]
