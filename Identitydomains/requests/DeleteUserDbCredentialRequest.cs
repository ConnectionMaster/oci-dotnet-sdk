...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/DeleteUserDbCredential.cs.html">here</a> to see an example of how to use DeleteUserDbCredential request.
    /// </example>
    public class DeleteUserDbCredentialRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UserDbCredentialId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "userDbCredentialId")]
