...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/PutSecurityQuestionSetting.cs.html">here</a> to see an example of how to use PutSecurityQuestionSetting request.
    /// </example>
    public class PutSecurityQuestionSettingRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "SecurityQuestionSettingId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "securityQuestionSettingId")]
        ...
        public SecurityQuestionSetting SecurityQuestionSetting { get; set; }
