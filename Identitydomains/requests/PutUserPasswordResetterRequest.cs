...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/PutUserPasswordResetter.cs.html">here</a> to see an example of how to use PutUserPasswordResetter request.
    /// </example>
    public class PutUserPasswordResetterRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UserPasswordResetterId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "userPasswordResetterId")]
        public string UserPasswordResetterId { get; set; }
        ...
        public UserPasswordResetter UserPasswordResetter { get; set; }
