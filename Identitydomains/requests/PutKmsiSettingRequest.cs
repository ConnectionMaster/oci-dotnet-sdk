...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/PutKmsiSetting.cs.html">here</a> to see an example of how to use PutKmsiSetting request.
    /// </example>
    public class PutKmsiSettingRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "KmsiSettingId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "kmsiSettingId")]
        ...
        public KmsiSetting KmsiSetting { get; set; }
