...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/DeleteMySmtpCredential.cs.html">here</a> to see an example of how to use DeleteMySmtpCredential request.
    /// </example>
    public class DeleteMySmtpCredentialRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "MySmtpCredentialId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "mySmtpCredentialId")]
        public string MySmtpCredentialId { get; set; }
