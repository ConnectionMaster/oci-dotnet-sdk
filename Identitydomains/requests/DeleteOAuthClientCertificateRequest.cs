...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/DeleteOAuthClientCertificate.cs.html">here</a> to see an example of how to use DeleteOAuthClientCertificate request.
    /// </example>
    public class DeleteOAuthClientCertificateRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "OAuthClientCertificateId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "oAuthClientCertificateId")]
