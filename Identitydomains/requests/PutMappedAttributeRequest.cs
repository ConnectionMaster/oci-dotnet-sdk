...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/PutMappedAttribute.cs.html">here</a> to see an example of how to use PutMappedAttribute request.
    /// </example>
    public class PutMappedAttributeRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "MappedAttributeId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "mappedAttributeId")]
        public string MappedAttributeId { get; set; }
        ...
        public MappedAttribute MappedAttribute { get; set; }
