...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/CreateUserDbCredential.cs.html">here</a> to see an example of how to use CreateUserDbCredential request.
    /// </example>
    public class CreateUserDbCredentialRequest : Oci.Common.IOciRequest
    {
        ...
        public UserDbCredential UserDbCredential { get; set; }
