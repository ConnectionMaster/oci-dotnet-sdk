...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/DeleteMyAuthToken.cs.html">here</a> to see an example of how to use DeleteMyAuthToken request.
    /// </example>
    public class DeleteMyAuthTokenRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "MyAuthTokenId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "myAuthTokenId")]
        public string MyAuthTokenId { get; set; }
