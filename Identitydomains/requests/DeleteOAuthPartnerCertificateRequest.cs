...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/DeleteOAuthPartnerCertificate.cs.html">here</a> to see an example of how to use DeleteOAuthPartnerCertificate request.
    /// </example>
    public class DeleteOAuthPartnerCertificateRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "OAuthPartnerCertificateId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "oAuthPartnerCertificateId")]
        public string OAuthPartnerCertificateId { get; set; }
