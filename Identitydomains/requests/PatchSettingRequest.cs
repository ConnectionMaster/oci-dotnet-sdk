...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/PatchSetting.cs.html">here</a> to see an example of how to use PatchSetting request.
    /// </example>
    public class PatchSettingRequest : Oci.Common.IOciRequest
    {
        ...
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "settingId")]
