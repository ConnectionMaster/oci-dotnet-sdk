...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/CreateCloudGateServer.cs.html">here</a> to see an example of how to use CreateCloudGateServer request.
    /// </example>
    public class CreateCloudGateServerRequest : Oci.Common.IOciRequest
    {
