...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/PutUserStatusChanger.cs.html">here</a> to see an example of how to use PutUserStatusChanger request.
    /// </example>
    public class PutUserStatusChangerRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UserStatusChangerId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "userStatusChangerId")]
        public string UserStatusChangerId { get; set; }
        ...
        public UserStatusChanger UserStatusChanger { get; set; }
