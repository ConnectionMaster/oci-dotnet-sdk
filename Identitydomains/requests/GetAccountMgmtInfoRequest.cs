...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/GetAccountMgmtInfo.cs.html">here</a> to see an example of how to use GetAccountMgmtInfo request.
    /// </example>
    public class GetAccountMgmtInfoRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "AccountMgmtInfoId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "accountMgmtInfoId")]
