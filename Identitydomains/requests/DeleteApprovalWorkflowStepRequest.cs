...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/DeleteApprovalWorkflowStep.cs.html">here</a> to see an example of how to use DeleteApprovalWorkflowStep request.
    /// </example>
    public class DeleteApprovalWorkflowStepRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "ApprovalWorkflowStepId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "approvalWorkflowStepId")]
