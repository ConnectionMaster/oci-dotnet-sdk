...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/DeleteApprovalWorkflow.cs.html">here</a> to see an example of how to use DeleteApprovalWorkflow request.
    /// </example>
    public class DeleteApprovalWorkflowRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "ApprovalWorkflowId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "approvalWorkflowId")]
