...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/CreatePasswordPolicy.cs.html">here</a> to see an example of how to use CreatePasswordPolicy request.
    /// </example>
    public class CreatePasswordPolicyRequest : Oci.Common.IOciRequest
    {
