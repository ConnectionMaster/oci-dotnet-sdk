...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/PutCloudGateServer.cs.html">here</a> to see an example of how to use PutCloudGateServer request.
    /// </example>
    public class PutCloudGateServerRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "CloudGateServerId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "cloudGateServerId")]
        ...
        public CloudGateServer CloudGateServer { get; set; }
