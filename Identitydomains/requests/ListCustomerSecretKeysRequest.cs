...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/ListCustomerSecretKeys.cs.html">here</a> to see an example of how to use ListCustomerSecretKeys request.
    /// </example>
    public class ListCustomerSecretKeysRequest : Oci.Common.IOciRequest
    {
