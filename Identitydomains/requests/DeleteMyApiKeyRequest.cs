...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/DeleteMyApiKey.cs.html">here</a> to see an example of how to use DeleteMyApiKey request.
    /// </example>
    public class DeleteMyApiKeyRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "MyApiKeyId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "myApiKeyId")]
        public string MyApiKeyId { get; set; }
