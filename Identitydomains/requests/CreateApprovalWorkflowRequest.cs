...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/CreateApprovalWorkflow.cs.html">here</a> to see an example of how to use CreateApprovalWorkflow request.
    /// </example>
    public class CreateApprovalWorkflowRequest : Oci.Common.IOciRequest
    {
