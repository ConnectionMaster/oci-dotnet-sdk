...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/PutUserPasswordChanger.cs.html">here</a> to see an example of how to use PutUserPasswordChanger request.
    /// </example>
    public class PutUserPasswordChangerRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UserPasswordChangerId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "userPasswordChangerId")]
        public string UserPasswordChangerId { get; set; }
        ...
        public UserPasswordChanger UserPasswordChanger { get; set; }
