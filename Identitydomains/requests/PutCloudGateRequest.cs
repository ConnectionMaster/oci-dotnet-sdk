...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/PutCloudGate.cs.html">here</a> to see an example of how to use PutCloudGate request.
    /// </example>
    public class PutCloudGateRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "CloudGateId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "cloudGateId")]
        ...
        public CloudGate CloudGate { get; set; }
