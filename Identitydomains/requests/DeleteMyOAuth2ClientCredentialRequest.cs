...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/DeleteMyOAuth2ClientCredential.cs.html">here</a> to see an example of how to use DeleteMyOAuth2ClientCredential request.
    /// </example>
    public class DeleteMyOAuth2ClientCredentialRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "MyOAuth2ClientCredentialId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "myOAuth2ClientCredentialId")]
