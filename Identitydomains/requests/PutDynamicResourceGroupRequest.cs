...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/PutDynamicResourceGroup.cs.html">here</a> to see an example of how to use PutDynamicResourceGroup request.
    /// </example>
    public class PutDynamicResourceGroupRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "DynamicResourceGroupId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "dynamicResourceGroupId")]
        ...
        public DynamicResourceGroup DynamicResourceGroup { get; set; }
