...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/DeleteSecurityQuestion.cs.html">here</a> to see an example of how to use DeleteSecurityQuestion request.
    /// </example>
    public class DeleteSecurityQuestionRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "SecurityQuestionId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "securityQuestionId")]
