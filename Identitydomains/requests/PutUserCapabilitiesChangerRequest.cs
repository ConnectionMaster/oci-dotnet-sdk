...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/PutUserCapabilitiesChanger.cs.html">here</a> to see an example of how to use PutUserCapabilitiesChanger request.
    /// </example>
    public class PutUserCapabilitiesChangerRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UserCapabilitiesChangerId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "userCapabilitiesChangerId")]
        public string UserCapabilitiesChangerId { get; set; }
        ...
        public UserCapabilitiesChanger UserCapabilitiesChanger { get; set; }
