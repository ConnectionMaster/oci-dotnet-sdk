...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/GetBrandingSetting.cs.html">here</a> to see an example of how to use GetBrandingSetting request.
    /// </example>
    public class GetBrandingSettingRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "BrandingSettingId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "brandingSettingId")]
