...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/PatchMyRequest.cs.html">here</a> to see an example of how to use PatchMyRequest request.
    /// </example>
    public class PatchMyRequestRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "MyRequestId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "myRequestId")]
        public string MyRequestId { get; set; }
