...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/identitydomains/PutAppStatusChanger.cs.html">here</a> to see an example of how to use PutAppStatusChanger request.
    /// </example>
    public class PutAppStatusChangerRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "AppStatusChangerId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "appStatusChangerId")]
        public string AppStatusChangerId { get; set; }
        ...
        public AppStatusChanger AppStatusChanger { get; set; }
