...
namespace Oci.ResourceschedulerService.Responses
{
    public class ListResourceTypesResponse : Oci.Common.OciResponse
    {
        ...
        public ResourceTypeCollection ResourceTypeCollection { get; set; }
