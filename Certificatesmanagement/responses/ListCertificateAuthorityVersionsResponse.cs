...
{
    public class ListCertificateAuthorityVersionsResponse : Oci.Common.OciResponse
    {
        ...
        public CertificateAuthorityVersionCollection CertificateAuthorityVersionCollection { get; set; }
