...
namespace Oci.KeymanagementService.Requests
{
    ...
    public class UpdateRegisteredVaultForMtlsRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UpdateRegisteredVaultForMtlsDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public UpdateRegisteredVaultForMtlsDetails UpdateRegisteredVaultForMtlsDetails { get; set; }
