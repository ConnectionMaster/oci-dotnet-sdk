...
namespace Oci.OnesubscriptionService
{
    ...
    public class BillingScheduleClient : RegionalClientBase
    {
        ...
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/onesubscription/ListBillingSchedules.cs.html">here</a> to see an example of how to use ListBillingSchedules API.</example>
