...
namespace Oci.OnesubscriptionService
{
    ...
    public class SubscriptionClient : RegionalClientBase
    {
        ...
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/onesubscription/ListSubscriptions.cs.html">here</a> to see an example of how to use ListSubscriptions API.</example>
