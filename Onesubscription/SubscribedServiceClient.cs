...
{
    /// <summary>Service client instance for SubscribedService.</summary>
    public class SubscribedServiceClient : RegionalClientBase
    {
            ...
            : base(authenticationDetailsProvider, clientConfiguration)
        {
            ...
            Paginators = new SubscribedServicePaginators(this);
        }
        ...
        public async Task<GetSubscribedServiceResponse> GetSubscribedService(GetSubscribedServiceRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            Uri uri = new Uri(this.restClient.GetEndpoint(), System.IO.Path.Combine(basePathWithoutHost, "/subscribedServices/{subscribedServiceId}".Trim('/')));
            ...
            try
            {
                ...
                {
                    ServiceName = "SubscribedService",
                    OperationName = "GetSubscribedService",
                ...
                return Converter.FromHttpResponseMessage<GetSubscribedServiceResponse>(responseMessage);
            }
            ...
            {
                logger.Error($"GetSubscribedService failed with error: {e.Message}");
                throw;
            }
        }
        ...
        public async Task<ListSubscribedServicesResponse> ListSubscribedServices(ListSubscribedServicesRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            Uri uri = new Uri(this.restClient.GetEndpoint(), System.IO.Path.Combine(basePathWithoutHost, "/subscribedServices".Trim('/')));
            HttpMethod method = new HttpMethod("GET");
            HttpRequestMessage requestMessage = Converter.ToHttpRequestMessage(uri, method, request);
            requestMessage.Headers.Add("Accept", "application/json");
            GenericRetrier retryingClient = Retrier.GetPreferredRetrier(retryConfiguration, this.retryConfiguration);
            ...
            try
            {
                ...
                {
                    ServiceName = "SubscribedService",
                    OperationName = "ListSubscribedServices",
                    RequestEndpoint = $"{method.Method} {requestMessage.RequestUri}",
                    ApiReferenceLink = "",
                    UserAgent = this.GetUserAgent()
                };
                this.restClient.CheckHttpResponseMessage(requestMessage, responseMessage, apiDetails);
                logger.Debug($"Total Latency for this API call is: {stopWatch.ElapsedMilliseconds} ms");
                return Converter.FromHttpResponseMessage<ListSubscribedServicesResponse>(responseMessage);
            }
            catch (OciException e)
            {
                logger.Error(e);
            ...
            {
                logger.Error($"ListSubscribedServices failed with error: {e.Message}");
                throw;
            }
        }
