...
namespace Oci.ApmconfigService
{
    ...
    /// to any list operations of Config where multiple pages of data may be fetched.
    ...
    {
        private readonly ConfigClient client;

        public ConfigPaginators(ConfigClient client)
        {
            this.client = client;
        }
