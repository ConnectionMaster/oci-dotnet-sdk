...
namespace Oci.EmaildataplaneService
{
    ...
    public class EmailDPClient : RegionalClientBase
    {
        ...
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/emaildataplane/SubmitEmail.cs.html">here</a> to see an example of how to use SubmitEmail API.</example>
        ...
        /// <param name="completionOption">The completion option for this operation. Optional.</param>
        /// <returns>A response object containing details about the completed operation</returns>
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/emaildataplane/SubmitRawEmail.cs.html">here</a> to see an example of how to use SubmitRawEmail API.</example>
