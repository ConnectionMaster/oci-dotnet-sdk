...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/marketplace/UpdateAcceptedAgreement.cs.html">here</a> to see an example of how to use UpdateAcceptedAgreement request.
    /// </example>
    public class UpdateAcceptedAgreementRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "AcceptedAgreementId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "acceptedAgreementId")]
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UpdateAcceptedAgreementDetails is required.")]
