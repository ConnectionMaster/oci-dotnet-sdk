...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/marketplace/CreateMarketplaceExternalAttestedMetadata.cs.html">here</a> to see an example of how to use CreateMarketplaceExternalAttestedMetadata request.
    /// </example>
    public class CreateMarketplaceExternalAttestedMetadataRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "CreateMarketplaceExternalAttestedMetadataDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public CreateMarketplaceExternalAttestedMetadataDetails CreateMarketplaceExternalAttestedMetadataDetails { get; set; }
