...
namespace Oci.VnmonitoringService.Models
{
    ...
    public class EgressSecurityRule 
    {
        ...
        /// Allowed values:
        /// <br/>
        ///   * IP address range in CIDR notation. For Example: 192.168.1.0/24 or 2001:0db8:0123:45::/56    Note that IPv6 addressing is currently supported only in certain regions. See    [IPv6 Addresses](https://docs.oracle.com/iaas/Content/Network/Concepts/ipv6.htm).  * The cidrBlock value for a {@link Service}, if you're    setting up a security list rule for traffic destined for a particular Service through    a service gateway. For
        /// </value>
        /// <remarks>
        /// Required
        /// </remarks>
