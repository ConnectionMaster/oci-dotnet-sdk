...
namespace Oci.ManagedkafkaService.Models
{
    ...
    public class UpdateAddonDetailsModelConverter : JsonConverter
    {
        public override bool CanWrite => false;
        public override bool CanRead => true;
        public override bool CanConvert(System.Type type)
        {
            return type == typeof(UpdateAddonDetails);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(UpdateAddonDetails);
            var discriminator = jsonObject["addonType"].Value<string>();
            switch (discriminator)
            {
                case "PUBLICCONNECTIVITY":
                    obj = new UpdatePublicConnectivityAddonDetails();
                    break;
            }
