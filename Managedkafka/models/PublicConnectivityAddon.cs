...
namespace Oci.ManagedkafkaService.Models
{
    ...
    public class PublicConnectivityAddon : KafkaClusterAddon
    {
        ...
        public System.Nullable<AuthenticationMechanism> AuthenticationMechanism { get; set; }
        ...
        public System.Collections.Generic.List<string> NetworkCidrs { get; set; }
        
        [JsonProperty(PropertyName = "addonType")]
        private readonly string addonType = "PUBLICCONNECTIVITY";
    }
}
