...
namespace Oci.ManagedkafkaService.Models
{
    ...
    /// </summary>
    public class CreateKafkaClusterConfigDetails 
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "LatestConfig is required.")]
        [JsonProperty(PropertyName = "latestConfig")]
        public KafkaClusterConfigVersion LatestConfig { get; set; }
