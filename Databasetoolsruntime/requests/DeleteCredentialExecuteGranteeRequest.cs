...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/databasetoolsruntime/DeleteCredentialExecuteGrantee.cs.html">here</a> to see an example of how to use DeleteCredentialExecuteGrantee request.
    /// </example>
    public class DeleteCredentialExecuteGranteeRequest : Oci.Common.IOciRequest
    {
        ...
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "executeGranteeKey")]
