...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/databasetoolsruntime/ListUserCredentials.cs.html">here</a> to see an example of how to use ListUserCredentials request.
    /// </example>
    public class ListUserCredentialsRequest : Oci.Common.IOciRequest
    {
