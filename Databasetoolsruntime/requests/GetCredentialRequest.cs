...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/databasetoolsruntime/GetCredential.cs.html">here</a> to see an example of how to use GetCredential request.
    /// </example>
    public class GetCredentialRequest : Oci.Common.IOciRequest
    {
