...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/databasetoolsruntime/ListCredentials.cs.html">here</a> to see an example of how to use ListCredentials request.
    /// </example>
    public class ListCredentialsRequest : Oci.Common.IOciRequest
    {
