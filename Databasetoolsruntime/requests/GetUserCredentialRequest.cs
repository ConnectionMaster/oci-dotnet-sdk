...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/databasetoolsruntime/GetUserCredential.cs.html">here</a> to see an example of how to use GetUserCredential request.
    /// </example>
    public class GetUserCredentialRequest : Oci.Common.IOciRequest
    {
