...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/databasetoolsruntime/DeleteDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpec.cs.html">here</a> to see an example of how to use DeleteDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpec request.
    /// </example>
    public class DeleteDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecRequest : Oci.Common.IOciRequest
    {
        ...
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "autoApiSpecKey")]
