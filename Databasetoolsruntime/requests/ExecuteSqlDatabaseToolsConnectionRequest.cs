...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/databasetoolsruntime/ExecuteSqlDatabaseToolsConnection.cs.html">here</a> to see an example of how to use ExecuteSqlDatabaseToolsConnection request.
    /// </example>
    public class ExecuteSqlDatabaseToolsConnectionRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "ExecuteSqlDatabaseToolsConnectionDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public ExecuteSqlDatabaseToolsConnectionDetails ExecuteSqlDatabaseToolsConnectionDetails { get; set; }
