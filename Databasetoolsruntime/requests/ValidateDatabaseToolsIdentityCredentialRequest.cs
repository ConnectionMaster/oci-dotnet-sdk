...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/databasetoolsruntime/ValidateDatabaseToolsIdentityCredential.cs.html">here</a> to see an example of how to use ValidateDatabaseToolsIdentityCredential request.
    /// </example>
    public class ValidateDatabaseToolsIdentityCredentialRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "DatabaseToolsIdentityId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "databaseToolsIdentityId")]
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "ValidateDatabaseToolsIdentityCredentialDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public ValidateDatabaseToolsIdentityCredentialDetails ValidateDatabaseToolsIdentityCredentialDetails { get; set; }
