...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/databasetoolsruntime/UpdatePropertySet.cs.html">here</a> to see an example of how to use UpdatePropertySet request.
    /// </example>
    public class UpdatePropertySetRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "PropertySetKey is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "propertySetKey")]
        public System.Nullable<PropertySetKey> PropertySetKey { get; set; }
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UpdatePropertySetDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public UpdatePropertySetDetails UpdatePropertySetDetails { get; set; }
