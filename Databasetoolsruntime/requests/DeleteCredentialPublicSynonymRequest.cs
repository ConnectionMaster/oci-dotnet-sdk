...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/databasetoolsruntime/DeleteCredentialPublicSynonym.cs.html">here</a> to see an example of how to use DeleteCredentialPublicSynonym request.
    /// </example>
    public class DeleteCredentialPublicSynonymRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "PublicSynonymKey is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "publicSynonymKey")]
