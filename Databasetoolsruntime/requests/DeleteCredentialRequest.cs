...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/databasetoolsruntime/DeleteCredential.cs.html">here</a> to see an example of how to use DeleteCredential request.
    /// </example>
    public class DeleteCredentialRequest : Oci.Common.IOciRequest
    {
