...
namespace Oci.DatabasetoolsruntimeService.Models
{
    ...
    public class DatabaseToolsDatabaseApiGatewayConfigPoolContent 
    {
        ...
        public System.Collections.Generic.List<DatabaseToolsDatabaseApiGatewayConfigPoolApiSpec> ApiSpecs { get; set; }
        
        /// <value>
        /// Array of Database Tools database API gateway config auto API spec items.
        /// </value>
        [JsonProperty(PropertyName = "autoApiSpecs")]
        public System.Collections.Generic.List<DatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpec> AutoApiSpecs { get; set; }
    ...
    public class DatabaseToolsDatabaseApiGatewayConfigPoolContentModelConverter : JsonConverter
    {
        public override bool CanWrite => false;
        public override bool CanRead => true;
        public override bool CanConvert(System.Type type)
        {
            return type == typeof(DatabaseToolsDatabaseApiGatewayConfigPoolContent);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(DatabaseToolsDatabaseApiGatewayConfigPoolContent);
            var discriminator = jsonObject["type"].Value<string>();
            switch (discriminator)
            {
                case "DEFAULT":
                    obj = new DatabaseToolsDatabaseApiGatewayConfigPoolContentDefault();
                    break;
            }
