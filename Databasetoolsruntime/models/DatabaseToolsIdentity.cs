...
namespace Oci.DatabasetoolsruntimeService.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(DatabaseToolsIdentityModelConverter))]
    public class DatabaseToolsIdentity 
    {
        
        /// <value>
        /// The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Database Tools identity.
        /// </value>
        /// <remarks>
        /// Required
        /// </remarks>
    ...
    public class DatabaseToolsIdentityModelConverter : JsonConverter
    {
        public override bool CanWrite => false;
        public override bool CanRead => true;
        public override bool CanConvert(System.Type type)
        {
            return type == typeof(DatabaseToolsIdentity);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(DatabaseToolsIdentity);
            var discriminator = jsonObject["type"].Value<string>();
            switch (discriminator)
            {
                case "ORACLE_DATABASE_RESOURCE_PRINCIPAL":
                    obj = new DatabaseToolsIdentityOracleDatabaseResourcePrincipal();
                    break;
            }
