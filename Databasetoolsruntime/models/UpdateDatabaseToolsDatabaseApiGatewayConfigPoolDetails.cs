...
namespace Oci.DatabasetoolsruntimeService.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(UpdateDatabaseToolsDatabaseApiGatewayConfigPoolDetailsModelConverter))]
    ...
    public class UpdateDatabaseToolsDatabaseApiGatewayConfigPoolDetailsModelConverter : JsonConverter
    {
        public override bool CanWrite => false;
        public override bool CanRead => true;
        public override bool CanConvert(System.Type type)
        {
            return type == typeof(UpdateDatabaseToolsDatabaseApiGatewayConfigPoolDetails);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(UpdateDatabaseToolsDatabaseApiGatewayConfigPoolDetails);
            var discriminator = jsonObject["type"].Value<string>();
            switch (discriminator)
            {
                case "DEFAULT":
                    obj = new UpdateDatabaseToolsDatabaseApiGatewayConfigPoolDefaultDetails();
                    break;
            }
