...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/mysql/GetChannelStatus.cs.html">here</a> to see an example of how to use GetChannelStatus request.
    /// </example>
    public class GetChannelStatusRequest : Oci.Common.IOciRequest
    {
