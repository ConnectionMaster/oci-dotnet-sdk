...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/mysql/GenerateChannelStatus.cs.html">here</a> to see an example of how to use GenerateChannelStatus request.
    /// </example>
    public class GenerateChannelStatusRequest : Oci.Common.IOciRequest
    {
