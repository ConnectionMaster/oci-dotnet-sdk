...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/governancerulescontrolplane/ListTenancyAttachments.cs.html">here</a> to see an example of how to use ListTenancyAttachments request.
    /// </example>
    public class ListTenancyAttachmentsRequest : Oci.Common.IOciRequest
    {
        ...
        /// </value>
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "tenancyAttachmentId")]
        ...
        public System.Nullable<TenancyAttachment.LifecycleStateEnum> LifecycleState { get; set; }
        
        /// <value>
        /// A filter to return only governance rules that match the given tenancy id.
        /// </value>
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "childTenancyId")]
