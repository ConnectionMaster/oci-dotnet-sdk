...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/loganalytics/DeleteLogAnalyticsEntity.cs.html">here</a> to see an example of how to use DeleteLogAnalyticsEntity request.
    /// </example>
    public class DeleteLogAnalyticsEntityRequest : Oci.Common.IOciRequest
    {
