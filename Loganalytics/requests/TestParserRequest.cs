...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/loganalytics/TestParser.cs.html">here</a> to see an example of how to use TestParser request.
    /// </example>
    public class TestParserRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "TestParserPayloadDetails is required.")]
        ...
        public enum ScopeEnum {
            [EnumMember(Value = "LOG_LINES")]
            LogLines,
            [EnumMember(Value = "LOG_ENTRIES")]
            LogEntries,
            [EnumMember(Value = "LOG_LINES_LOG_ENTRIES")]
            LogLinesLogEntries
        };
