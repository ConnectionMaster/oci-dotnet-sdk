...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/loganalytics/ValidateSourceMapping.cs.html">here</a> to see an example of how to use ValidateSourceMapping request.
    /// </example>
    public class ValidateSourceMappingRequest : Oci.Common.IOciRequest
    {
        ...
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "objectLocation")]
