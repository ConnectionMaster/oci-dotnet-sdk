...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/loganalytics/ValidateSource.cs.html">here</a> to see an example of how to use ValidateSource request.
    /// </example>
    public class ValidateSourceRequest : Oci.Common.IOciRequest
    {
