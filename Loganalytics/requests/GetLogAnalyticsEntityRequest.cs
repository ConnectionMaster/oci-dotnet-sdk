...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/loganalytics/GetLogAnalyticsEntity.cs.html">here</a> to see an example of how to use GetLogAnalyticsEntity request.
    /// </example>
    public class GetLogAnalyticsEntityRequest : Oci.Common.IOciRequest
    {
