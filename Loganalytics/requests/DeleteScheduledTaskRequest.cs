...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/loganalytics/DeleteScheduledTask.cs.html">here</a> to see an example of how to use DeleteScheduledTask request.
    /// </example>
    public class DeleteScheduledTaskRequest : Oci.Common.IOciRequest
    {
