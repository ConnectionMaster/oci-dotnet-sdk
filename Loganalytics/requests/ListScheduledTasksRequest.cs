...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/loganalytics/ListScheduledTasks.cs.html">here</a> to see an example of how to use ListScheduledTasks request.
    /// </example>
    public class ListScheduledTasksRequest : Oci.Common.IOciRequest
    {
