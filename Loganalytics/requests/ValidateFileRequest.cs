...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/loganalytics/ValidateFile.cs.html">here</a> to see an example of how to use ValidateFile request.
    /// </example>
    public class ValidateFileRequest : Oci.Common.IOciRequest
    {
