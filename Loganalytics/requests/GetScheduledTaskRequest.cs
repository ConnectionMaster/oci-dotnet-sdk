...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/loganalytics/GetScheduledTask.cs.html">here</a> to see an example of how to use GetScheduledTask request.
    /// </example>
    public class GetScheduledTaskRequest : Oci.Common.IOciRequest
    {
