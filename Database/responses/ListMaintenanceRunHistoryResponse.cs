...
{
    public class ListMaintenanceRunHistoryResponse : Oci.Common.OciResponse
    {
        ...
        public System.Collections.Generic.List<MaintenanceRunHistorySummary> Items { get; set; }
