...
{
    public class ListAutonomousDatabaseClonesResponse : Oci.Common.OciResponse
    {
        ...
        public System.Collections.Generic.List<AutonomousDatabaseSummary> Items { get; set; }
