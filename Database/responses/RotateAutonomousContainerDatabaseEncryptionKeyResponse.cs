...
{
    public class RotateAutonomousContainerDatabaseEncryptionKeyResponse : Oci.Common.OciResponse
    {
        ...
        public AutonomousContainerDatabase AutonomousContainerDatabase { get; set; }
