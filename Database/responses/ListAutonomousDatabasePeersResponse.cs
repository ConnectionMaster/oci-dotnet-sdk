...
{
    public class ListAutonomousDatabasePeersResponse : Oci.Common.OciResponse
    {
        ...
        public AutonomousDatabasePeerCollection AutonomousDatabasePeerCollection { get; set; }
