...
{
    public class UpdateAutonomousExadataInfrastructureResponse : Oci.Common.OciResponse
    {
        ...
        public AutonomousExadataInfrastructure AutonomousExadataInfrastructure { get; set; }
