...
{
    public class ListEstimateCostSavingsResponse : Oci.Common.OciResponse
    {
        ...
        public EstimateCostSavingsSummaryCollection EstimateCostSavingsSummaryCollection { get; set; }
