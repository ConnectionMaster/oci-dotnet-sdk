...
{
    public class UpdateExternalNonContainerDatabaseResponse : Oci.Common.OciResponse
    {
        ...
        public ExternalNonContainerDatabase ExternalNonContainerDatabase { get; set; }
