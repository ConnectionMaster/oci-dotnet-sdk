...
{
    public class ListExternalPluggableDatabasesResponse : Oci.Common.OciResponse
    {
        ...
        public System.Collections.Generic.List<ExternalPluggableDatabaseSummary> Items { get; set; }
