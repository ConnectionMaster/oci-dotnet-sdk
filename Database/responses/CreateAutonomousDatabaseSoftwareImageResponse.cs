...
{
    public class CreateAutonomousDatabaseSoftwareImageResponse : Oci.Common.OciResponse
    {
        ...
        public AutonomousDatabaseSoftwareImage AutonomousDatabaseSoftwareImage { get; set; }
