...
{
    public class ListAutonomousDatabasesInAutonomousContainerDatabaseBackupResponse : Oci.Common.OciResponse
    {
        ...
        public AutonomousDatabaseInBackupCollection AutonomousDatabaseInBackupCollection { get; set; }
