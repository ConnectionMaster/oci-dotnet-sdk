...
{
    public class ListBaseccVmClusterUpdatesResponse : Oci.Common.OciResponse
    {
        ...
        public System.Collections.Generic.List<BaseccVmClusterUpdateSummary> Items { get; set; }
