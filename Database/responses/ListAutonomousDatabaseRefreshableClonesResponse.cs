...
{
    public class ListAutonomousDatabaseRefreshableClonesResponse : Oci.Common.OciResponse
    {
        ...
        public RefreshableCloneCollection RefreshableCloneCollection { get; set; }
