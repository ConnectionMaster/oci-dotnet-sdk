...
namespace Oci.DatabaseService.Models
{
    ...
    /// 
    /// </summary>
    [JsonConverter(typeof(CreateExternalDatabaseConnectorDetailsModelConverter))]
    ...
    public class CreateExternalDatabaseConnectorDetailsModelConverter : JsonConverter
    {
        public override bool CanWrite => false;
        public override bool CanRead => true;
        public override bool CanConvert(System.Type type)
        {
            return type == typeof(CreateExternalDatabaseConnectorDetails);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(CreateExternalDatabaseConnectorDetails);
            var discriminator = jsonObject["connectorType"].Value<string>();
            switch (discriminator)
            {
                case "MACS":
                    obj = new CreateExternalMacsConnectorDetails();
                    break;
            }
