...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/database/ImportTransportableTablespace.cs.html">here</a> to see an example of how to use ImportTransportableTablespace request.
    /// </example>
    public class ImportTransportableTablespaceRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "ImportTransportableTablespaceDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public ImportTransportableTablespaceDetails ImportTransportableTablespaceDetails { get; set; }
