...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/database/ResizeVmClusterNetwork.cs.html">here</a> to see an example of how to use ResizeVmClusterNetwork request.
    /// </example>
    public class ResizeVmClusterNetworkRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "ResizeVmClusterNetworkDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public ResizeVmClusterNetworkDetails ResizeVmClusterNetworkDetails { get; set; }
