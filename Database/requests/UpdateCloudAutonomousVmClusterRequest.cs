...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/database/UpdateCloudAutonomousVmCluster.cs.html">here</a> to see an example of how to use UpdateCloudAutonomousVmCluster request.
    /// </example>
    public class UpdateCloudAutonomousVmClusterRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UpdateCloudAutonomousVmClusterDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public UpdateCloudAutonomousVmClusterDetails UpdateCloudAutonomousVmClusterDetails { get; set; }
