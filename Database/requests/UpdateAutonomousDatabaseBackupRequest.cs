...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/database/UpdateAutonomousDatabaseBackup.cs.html">here</a> to see an example of how to use UpdateAutonomousDatabaseBackup request.
    /// </example>
    public class UpdateAutonomousDatabaseBackupRequest : Oci.Common.IOciRequest
    {
        ...
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "autonomousDatabaseBackupId")]
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UpdateAutonomousDatabaseBackupDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public UpdateAutonomousDatabaseBackupDetails UpdateAutonomousDatabaseBackupDetails { get; set; }
