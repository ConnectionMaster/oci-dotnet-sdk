...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/containerengine/StartCredentialRotation.cs.html">here</a> to see an example of how to use StartCredentialRotation request.
    /// </example>
    public class StartCredentialRotationRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "StartCredentialRotationDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public StartCredentialRotationDetails StartCredentialRotationDetails { get; set; }
