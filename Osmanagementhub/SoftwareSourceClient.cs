...
namespace Oci.OsmanagementhubService
{
    ...
    public class SoftwareSourceClient : RegionalClientBase
    {
        ...
        public async Task<ListAvailableSoftwareSourcesToAddResponse> ListAvailableSoftwareSourcesToAdd(ListAvailableSoftwareSourcesToAddRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            Uri uri = new Uri(this.restClient.GetEndpoint(), System.IO.Path.Combine(basePathWithoutHost, "/softwareSources/actions/availableSoftwareSources".Trim('/')));
            HttpMethod method = new HttpMethod("POST");
            HttpRequestMessage requestMessage = Converter.ToHttpRequestMessage(uri, method, request);
            requestMessage.Headers.Add("Accept", "application/json");
            GenericRetrier retryingClient = Retrier.GetPreferredRetrier(retryConfiguration, this.retryConfiguration);
            ...
            try
            {
                ...
                {
                    ServiceName = "SoftwareSource",
                    OperationName = "ListAvailableSoftwareSourcesToAdd",
                    RequestEndpoint = $"{method.Method} {requestMessage.RequestUri}",
                ...
                this.restClient.CheckHttpResponseMessage(requestMessage, responseMessage, apiDetails);
                logger.Debug($"Total Latency for this API call is: {stopWatch.ElapsedMilliseconds} ms");
                return Converter.FromHttpResponseMessage<ListAvailableSoftwareSourcesToAddResponse>(responseMessage);
            }
            catch (OciException e)
            {
                logger.Error(e);
            ...
            {
                logger.Error($"ListAvailableSoftwareSourcesToAdd failed with error: {e.Message}");
                throw;
            }
        }
