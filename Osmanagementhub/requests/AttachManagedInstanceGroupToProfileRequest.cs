...
namespace Oci.OsmanagementhubService.Requests
{
    ...
    public class AttachManagedInstanceGroupToProfileRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "AttachManagedInstanceGroupToProfileDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public AttachManagedInstanceGroupToProfileDetails AttachManagedInstanceGroupToProfileDetails { get; set; }
