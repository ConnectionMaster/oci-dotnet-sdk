...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/osmanagementhub/ListPackageGroups.cs.html">here</a> to see an example of how to use ListPackageGroups request.
    /// </example>
    public class ListPackageGroupsRequest : Oci.Common.IOciRequest
    {
        ...
        /// </value>
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "groupType", Oci.Common.Http.CollectionFormatType.Multi)]
        public System.Collections.Generic.List<PackageGroup.GroupTypeEnum> GroupType { get; set; }
