...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/osmanagementhub/RemoveModuleStreamProfileFromManagedInstanceGroup.cs.html">here</a> to see an example of how to use RemoveModuleStreamProfileFromManagedInstanceGroup request.
    /// </example>
    public class RemoveModuleStreamProfileFromManagedInstanceGroupRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "RemoveModuleStreamProfileFromManagedInstanceGroupDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public RemoveModuleStreamProfileFromManagedInstanceGroupDetails RemoveModuleStreamProfileFromManagedInstanceGroupDetails { get; set; }
