...
namespace Oci.OsmanagementhubService.Requests
{
    ...
    public class DetachSoftwareSourcesFromManagedInstanceGroupRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "DetachSoftwareSourcesFromManagedInstanceGroupDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public DetachSoftwareSourcesFromManagedInstanceGroupDetails DetachSoftwareSourcesFromManagedInstanceGroupDetails { get; set; }
