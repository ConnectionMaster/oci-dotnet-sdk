...
{
    public class ListManagedInstanceAvailableWindowsUpdatesResponse : Oci.Common.OciResponse
    {
        ...
        public AvailableWindowsUpdateCollection AvailableWindowsUpdateCollection { get; set; }
