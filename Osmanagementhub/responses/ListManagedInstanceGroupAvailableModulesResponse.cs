...
{
    public class ListManagedInstanceGroupAvailableModulesResponse : Oci.Common.OciResponse
    {
        ...
        public ManagedInstanceGroupAvailableModuleCollection ManagedInstanceGroupAvailableModuleCollection { get; set; }
