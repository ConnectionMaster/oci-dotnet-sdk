...
{
    public class ListManagedInstanceGroupModulesResponse : Oci.Common.OciResponse
    {
        ...
        public ManagedInstanceGroupModuleCollection ManagedInstanceGroupModuleCollection { get; set; }
