...
{
    public class ListManagedInstanceGroupAvailablePackagesResponse : Oci.Common.OciResponse
    {
        ...
        public ManagedInstanceGroupAvailablePackageCollection ManagedInstanceGroupAvailablePackageCollection { get; set; }
