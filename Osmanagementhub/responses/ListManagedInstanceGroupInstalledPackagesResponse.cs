...
{
    public class ListManagedInstanceGroupInstalledPackagesResponse : Oci.Common.OciResponse
    {
        ...
        public ManagedInstanceGroupInstalledPackageCollection ManagedInstanceGroupInstalledPackageCollection { get; set; }
