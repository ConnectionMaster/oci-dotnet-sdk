...
{
    public class ListManagedInstanceInstalledWindowsUpdatesResponse : Oci.Common.OciResponse
    {
        ...
        public InstalledWindowsUpdateCollection InstalledWindowsUpdateCollection { get; set; }
