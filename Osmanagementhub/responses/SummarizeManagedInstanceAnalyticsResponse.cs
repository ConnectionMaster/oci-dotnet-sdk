...
{
    public class SummarizeManagedInstanceAnalyticsResponse : Oci.Common.OciResponse
    {
        ...
        public ManagedInstanceAnalyticCollection ManagedInstanceAnalyticCollection { get; set; }
