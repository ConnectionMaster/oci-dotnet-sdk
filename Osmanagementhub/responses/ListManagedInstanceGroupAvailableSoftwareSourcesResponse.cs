...
{
    public class ListManagedInstanceGroupAvailableSoftwareSourcesResponse : Oci.Common.OciResponse
    {
        ...
        public AvailableSoftwareSourceCollection AvailableSoftwareSourceCollection { get; set; }
