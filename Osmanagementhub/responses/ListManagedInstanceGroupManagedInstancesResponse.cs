...
{
    public class ListManagedInstanceGroupManagedInstancesResponse : Oci.Common.OciResponse
    {
        ...
        public ManagedInstanceCollection ManagedInstanceCollection { get; set; }
