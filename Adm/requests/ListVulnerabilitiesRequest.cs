...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/adm/ListVulnerabilities.cs.html">here</a> to see an example of how to use ListVulnerabilities request.
    /// </example>
    public class ListVulnerabilitiesRequest : Oci.Common.IOciRequest
    {
        ...
        /// </value>
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "isDirectVulnerability")]
        public System.Nullable<bool> IsDirectVulnerability { get; set; }
