...
namespace Oci.AdmService.Requests
{
    ...
    public class ChangeRemediationRecipeCompartmentRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "ChangeRemediationRecipeCompartmentDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public ChangeRemediationRecipeCompartmentDetails ChangeRemediationRecipeCompartmentDetails { get; set; }
