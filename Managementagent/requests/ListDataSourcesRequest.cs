...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/managementagent/ListDataSources.cs.html">here</a> to see an example of how to use ListDataSources request.
    /// </example>
    public class ListDataSourcesRequest : Oci.Common.IOciRequest
    {
        ...
        public enum SortByEnum {
            [EnumMember(Value = "dataSourceName")]
            DataSourceName,
            [EnumMember(Value = "dataSourceType")]
            DataSourceType
        };
