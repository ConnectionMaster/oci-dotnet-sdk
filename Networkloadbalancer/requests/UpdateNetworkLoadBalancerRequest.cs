...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/networkloadbalancer/UpdateNetworkLoadBalancer.cs.html">here</a> to see an example of how to use UpdateNetworkLoadBalancer request.
    /// </example>
    public class UpdateNetworkLoadBalancerRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UpdateNetworkLoadBalancerDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public UpdateNetworkLoadBalancerDetails UpdateNetworkLoadBalancerDetails { get; set; }
