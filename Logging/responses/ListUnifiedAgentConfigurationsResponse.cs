...
{
    public class ListUnifiedAgentConfigurationsResponse : Oci.Common.OciResponse
    {
        ...
        public UnifiedAgentConfigurationCollection UnifiedAgentConfigurationCollection { get; set; }
