...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/logging/UpdateUnifiedAgentConfiguration.cs.html">here</a> to see an example of how to use UpdateUnifiedAgentConfiguration request.
    /// </example>
    public class UpdateUnifiedAgentConfigurationRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UpdateUnifiedAgentConfigurationDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public UpdateUnifiedAgentConfigurationDetails UpdateUnifiedAgentConfigurationDetails { get; set; }
