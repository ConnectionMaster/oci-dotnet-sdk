...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/logging/UpdateLog.cs.html">here</a> to see an example of how to use UpdateLog request.
    /// </example>
    public class UpdateLogRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UpdateLogDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public UpdateLogDetails UpdateLogDetails { get; set; }
