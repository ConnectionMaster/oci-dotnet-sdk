...
namespace Oci.PsqlService
{
    ...
    public class PostgresqlPaginators
    {
        ...
        public PostgresqlPaginators(PostgresqlClient client)
        {
            this.client = client;
        }
        ...
        /// <summary>
        /// Creates a new enumerable which will iterate over the responses received from the ListConfigurations operation. This enumerable
        /// will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<ListConfigurationsResponse> ListConfigurationsResponseEnumerator(ListConfigurationsRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseEnumerable<ListConfigurationsRequest, ListConfigurationsResponse>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
        ...
        public IEnumerable<ConfigurationSummary> ListConfigurationsRecordEnumerator(ListConfigurationsRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseRecordEnumerable<ListConfigurationsRequest, ListConfigurationsResponse, ConfigurationSummary>(
                ...
                request => client.ListConfigurations(request, retryConfiguration, cancellationToken),
                response => response.ConfigurationCollection.Items
            );
        }
        ...
        public IEnumerable<DbSystemSummary> ListDbSystemsRecordEnumerator(ListDbSystemsRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseRecordEnumerable<ListDbSystemsRequest, ListDbSystemsResponse, DbSystemSummary>(
                ...
                request => client.ListDbSystems(request, retryConfiguration, cancellationToken),
                response => response.DbSystemCollection.Items
            );
        }

        /// <summary>
        /// Creates a new enumerable which will iterate over the responses received from the ListDefaultConfigurations operation. This enumerable
        /// will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<ListDefaultConfigurationsResponse> ListDefaultConfigurationsResponseEnumerator(ListDefaultConfigurationsRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseEnumerable<ListDefaultConfigurationsRequest, ListDefaultConfigurationsResponse>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
        ...
        /// <summary>
        /// Creates a new enumerable which will iterate over the DefaultConfigurationSummary objects
        /// contained in responses from the ListDefaultConfigurations operation. This enumerable will fetch more data from the server as needed.
        /// </summary>
        /// <param name="request">The request object containing the details to send</param>
        /// <param name="retryConfiguration">The configuration for retrying, may be null</param>
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<DefaultConfigurationSummary> ListDefaultConfigurationsRecordEnumerator(ListDefaultConfigurationsRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseRecordEnumerable<ListDefaultConfigurationsRequest, ListDefaultConfigurationsResponse, DefaultConfigurationSummary>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
        ...
        /// <summary>
        /// Creates a new enumerable which will iterate over the ShapeSummary objects
        ...
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<ShapeSummary> ListShapesRecordEnumerator(ListShapesRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseRecordEnumerable<ListShapesRequest, ListShapesResponse, ShapeSummary>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
                ...
                request => client.ListShapes(request, retryConfiguration, cancellationToken),
                response => response.ShapeCollection.Items
            );
        }
