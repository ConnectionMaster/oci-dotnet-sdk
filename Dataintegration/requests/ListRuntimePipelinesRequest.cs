...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/dataintegration/ListRuntimePipelines.cs.html">here</a> to see an example of how to use ListRuntimePipelines request.
    /// </example>
    public class ListRuntimePipelinesRequest : Oci.Common.IOciRequest
    {
        ...
        /// </value>
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "aggregatorType", Oci.Common.Http.CollectionFormatType.Multi)]
        public System.Collections.Generic.List<string> AggregatorType { get; set; }
