...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/dataintegration/ListExportRequests.cs.html">here</a> to see an example of how to use ListExportRequests request.
    /// </example>
    public class ListExportRequestsRequest : Oci.Common.IOciRequest
    {
        ...
        /// Specifies export status to use, either -  ALL, SUCCESSFUL, IN_PROGRESS, QUEUED, FAILED .
        /// </value>
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "exportStatus")]
        public System.Nullable<ExportStatusEnum> ExportStatus { get; set; }
