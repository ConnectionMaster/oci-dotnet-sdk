...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/dataintegration/ListCopyObjectRequests.cs.html">here</a> to see an example of how to use ListCopyObjectRequests request.
    /// </example>
    public class ListCopyObjectRequestsRequest : Oci.Common.IOciRequest
    {
        ...
        /// Specifies copy status to use, either -  ALL, SUCCESSFUL, IN_PROGRESS, QUEUED, FAILED .
        /// </value>
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "copyStatus")]
        public System.Nullable<CopyStatusEnum> CopyStatus { get; set; }
        ...
        /// This parameter allows users to specify which view of the copy object response to return. SUMMARY - Summary of the copy object response will be returned. This is the default option when no value is specified. DETAILS - Details of copy object response will be returned. This will include details of all the objects to be copied.
        /// </value>
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "projection")]
        public System.Nullable<ProjectionEnum> Projection { get; set; }
        
        /// <value>
        /// Specifies start time of a copy object request.
        /// </value>
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "timeStartedInMillis")]
        public System.Nullable<long> TimeStartedInMillis { get; set; }
        
        /// <value>
        /// Specifies end time of a copy object request.
        /// </value>
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "timeEndedInMillis")]
