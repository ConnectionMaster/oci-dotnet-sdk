...
{
    public class ListUserDefinedFunctionsResponse : Oci.Common.OciResponse
    {
        ...
        public UserDefinedFunctionSummaryCollection UserDefinedFunctionSummaryCollection { get; set; }
