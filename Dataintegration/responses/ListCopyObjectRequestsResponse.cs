...
{
    public class ListCopyObjectRequestsResponse : Oci.Common.OciResponse
    {
        ...
        public CopyObjectRequestSummaryCollection CopyObjectRequestSummaryCollection { get; set; }
