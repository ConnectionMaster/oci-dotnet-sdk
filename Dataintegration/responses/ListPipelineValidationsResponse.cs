...
{
    public class ListPipelineValidationsResponse : Oci.Common.OciResponse
    {
        ...
        public PipelineValidationSummaryCollection PipelineValidationSummaryCollection { get; set; }
