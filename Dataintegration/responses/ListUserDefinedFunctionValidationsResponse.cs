...
{
    public class ListUserDefinedFunctionValidationsResponse : Oci.Common.OciResponse
    {
        ...
        public UserDefinedFunctionValidationSummaryCollection UserDefinedFunctionValidationSummaryCollection { get; set; }
