...
{
    public class CreateUserDefinedFunctionValidationResponse : Oci.Common.OciResponse
    {
        ...
        public UserDefinedFunctionValidation UserDefinedFunctionValidation { get; set; }
