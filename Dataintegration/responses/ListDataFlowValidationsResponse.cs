...
{
    public class ListDataFlowValidationsResponse : Oci.Common.OciResponse
    {
        ...
        public DataFlowValidationSummaryCollection DataFlowValidationSummaryCollection { get; set; }
