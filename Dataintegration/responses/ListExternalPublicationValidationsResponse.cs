...
{
    public class ListExternalPublicationValidationsResponse : Oci.Common.OciResponse
    {
        ...
        public ExternalPublicationValidationSummaryCollection ExternalPublicationValidationSummaryCollection { get; set; }
