...
{
    public class ListExternalPublicationsResponse : Oci.Common.OciResponse
    {
        ...
        public ExternalPublicationSummaryCollection ExternalPublicationSummaryCollection { get; set; }
