...
{
    public class CreateExternalPublicationValidationResponse : Oci.Common.OciResponse
    {
        ...
        public ExternalPublicationValidation ExternalPublicationValidation { get; set; }
