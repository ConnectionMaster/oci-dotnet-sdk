...
{
    public class ListConnectionValidationsResponse : Oci.Common.OciResponse
    {
        ...
        public ConnectionValidationSummaryCollection ConnectionValidationSummaryCollection { get; set; }
