...
namespace Oci.MarketplacepublisherService.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(AdminListingRevisionAttachmentModelConverter))]
    public class AdminListingRevisionAttachment 
    {
    ...
    public class AdminListingRevisionAttachmentModelConverter : JsonConverter
    {
        public override bool CanWrite => false;
        public override bool CanRead => true;
        public override bool CanConvert(System.Type type)
        {
            return type == typeof(AdminListingRevisionAttachment);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(AdminListingRevisionAttachment);
            var discriminator = jsonObject["attachmentType"].Value<string>();
            switch (discriminator)
            {
                case "RELATED_DOCUMENT":
                    obj = new AdminRelatedDocumentAttachment();
                    break;
                case "SCREENSHOT":
                    obj = new AdminScreenShotAttachment();
                    break;
                case "REVIEW_SUPPORT_DOCUMENT":
                    obj = new AdminReviewSupportDocumentAttachment();
                    break;
                case "SUPPORTED_SERVICES":
                    obj = new AdminSupportedServiceAttachment();
                    break;
                case "CUSTOMER_SUCCESS":
                    obj = new AdminCustomerSuccessAttachment();
                    break;
                case "VIDEO":
                    obj = new AdminVideoAttachment();
                    break;
            }
