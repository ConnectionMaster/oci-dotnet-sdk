...
namespace Oci.MarketplacepublisherService.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(AdminListingRevisionPackageModelConverter))]
    ...
    public class AdminListingRevisionPackageModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(AdminListingRevisionPackage);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(AdminListingRevisionPackage);
            var discriminator = jsonObject["packageType"].Value<string>();
            switch (discriminator)
            {
                case "STACK":
                    obj = new AdminStackPackage();
                    break;
                case "CONTAINER_IMAGE":
                    obj = new AdminContainerPackage();
                    break;
                case "MACHINE_IMAGE":
                    obj = new AdminMachineImagePackage();
                    break;
                case "HELM_CHART":
                    obj = new AdminHelmChartPackage();
                    break;
            }
            if (obj != null)
            {
            ...
            {
                logger.Warn($"The type {discriminator} is not present under AdminListingRevisionPackage! Returning null value.");
            }
            return obj;
        }
    }
