...
namespace Oci.MarketplacepublisherService.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(AdminArtifactModelConverter))]
    public class AdminArtifact 
    {
        ...
        public System.Nullable<Artifact.StatusEnum> Status { get; set; }
        ...
        [JsonConverter(typeof(Oci.Common.Utils.ResponseEnumConverter))]
        public System.Nullable<Artifact.LifecycleStateEnum> LifecycleState { get; set; }
    ...
    public class AdminArtifactModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(AdminArtifact);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(AdminArtifact);
            var discriminator = jsonObject["artifactType"].Value<string>();
            switch (discriminator)
            {
                case "STACK":
                    obj = new AdminStackArtifact();
                    break;
                case "MACHINE_IMAGE":
                    obj = new AdminMachineImageArtifact();
                    break;
                case "HELM_CHART":
                    obj = new AdminKubernetesImageArtifact();
                    break;
                case "CONTAINER_IMAGE":
                    obj = new AdminContainerImageArtifact();
                    break;
            }
            if (obj != null)
            {
            ...
            {
                logger.Warn($"The type {discriminator} is not present under AdminArtifact! Returning null value.");
            }
            return obj;
        }
    }
