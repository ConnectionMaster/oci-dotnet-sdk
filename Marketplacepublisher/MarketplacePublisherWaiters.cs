...
namespace Oci.MarketplacepublisherService
{
    ...
    public class MarketplacePublisherWaiters
    {
        ...
        /// <param name="targetStates">Desired resource states. If multiple states are provided then the waiter will return once the resource reaches any of the provided states</param>
        /// <returns>a new Oci.common.Waiter instance</returns>
        public Waiter<GetCustomerInstanceReportExportRequest, GetCustomerInstanceReportExportResponse> ForCustomerInstanceReportExport(GetCustomerInstanceReportExportRequest request, params CustomerInstanceReportExport.LifecycleStateEnum[] targetStates)
        {
            return this.ForCustomerInstanceReportExport(request, WaiterConfiguration.DefaultWaiterConfiguration, targetStates);
        }
        ...
        /// <param name="targetStates">Desired resource states. If multiple states are provided then the waiter will return once the resource reaches any of the provided states</param>
        /// <returns>a new Oci.common.Waiter instance</returns>
        public Waiter<GetCustomerInstanceReportExportRequest, GetCustomerInstanceReportExportResponse> ForCustomerInstanceReportExport(GetCustomerInstanceReportExportRequest request, WaiterConfiguration config, params CustomerInstanceReportExport.LifecycleStateEnum[] targetStates)
        {
            var agent = new WaiterAgent<GetCustomerInstanceReportExportRequest, GetCustomerInstanceReportExportResponse>(
                request,
                request => client.GetCustomerInstanceReportExport(request),
                response => targetStates.Contains(response.CustomerInstanceReportExport.LifecycleState.Value)
            );
            return new Waiter<GetCustomerInstanceReportExportRequest, GetCustomerInstanceReportExportResponse>(config, agent);
        }
        /// <summary>
        /// Creates a waiter using default wait configuration.
        /// </summary>
