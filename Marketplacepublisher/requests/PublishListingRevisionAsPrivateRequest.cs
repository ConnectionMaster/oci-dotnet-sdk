...
namespace Oci.MarketplacepublisherService.Requests
{
    ...
    public class PublishListingRevisionAsPrivateRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "PublishListingRevisionAsPrivateDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public PublishListingRevisionAsPrivateDetails PublishListingRevisionAsPrivateDetails { get; set; }
