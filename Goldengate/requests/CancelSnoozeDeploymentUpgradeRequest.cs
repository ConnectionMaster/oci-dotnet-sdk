...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/goldengate/CancelSnoozeDeploymentUpgrade.cs.html">here</a> to see an example of how to use CancelSnoozeDeploymentUpgrade request.
    /// </example>
    public class CancelSnoozeDeploymentUpgradeRequest : Oci.Common.IOciRequest
    {
        ...
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "deploymentUpgradeId")]
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "CancelSnoozeDeploymentUpgradeDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public CancelSnoozeDeploymentUpgradeDetails CancelSnoozeDeploymentUpgradeDetails { get; set; }
