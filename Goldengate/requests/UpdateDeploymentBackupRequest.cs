...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/goldengate/UpdateDeploymentBackup.cs.html">here</a> to see an example of how to use UpdateDeploymentBackup request.
    /// </example>
    public class UpdateDeploymentBackupRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UpdateDeploymentBackupDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public UpdateDeploymentBackupDetails UpdateDeploymentBackupDetails { get; set; }
