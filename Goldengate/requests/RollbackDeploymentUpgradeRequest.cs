...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/goldengate/RollbackDeploymentUpgrade.cs.html">here</a> to see an example of how to use RollbackDeploymentUpgrade request.
    /// </example>
    public class RollbackDeploymentUpgradeRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "RollbackDeploymentUpgradeDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public RollbackDeploymentUpgradeDetails RollbackDeploymentUpgradeDetails { get; set; }
