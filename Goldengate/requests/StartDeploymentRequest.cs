...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/goldengate/StartDeployment.cs.html">here</a> to see an example of how to use StartDeployment request.
    /// </example>
    public class StartDeploymentRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "StartDeploymentDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public StartDeploymentDetails StartDeploymentDetails { get; set; }
