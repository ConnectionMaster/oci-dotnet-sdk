...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/goldengate/RemoveDeploymentLocalPeer.cs.html">here</a> to see an example of how to use RemoveDeploymentLocalPeer request.
    /// </example>
    public class RemoveDeploymentLocalPeerRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "RemoveDeploymentLocalPeerDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public RemoveDeploymentLocalPeerDetails RemoveDeploymentLocalPeerDetails { get; set; }
