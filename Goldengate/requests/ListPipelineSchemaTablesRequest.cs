...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/goldengate/ListPipelineSchemaTables.cs.html">here</a> to see an example of how to use ListPipelineSchemaTables request.
    /// </example>
    public class ListPipelineSchemaTablesRequest : Oci.Common.IOciRequest
    {
        ...
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "sourceSchemaName")]
        ...
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "targetSchemaName")]
