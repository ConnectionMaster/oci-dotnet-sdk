...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/goldengate/SwitchoverDeploymentPeer.cs.html">here</a> to see an example of how to use SwitchoverDeploymentPeer request.
    /// </example>
    public class SwitchoverDeploymentPeerRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "SwitchoverDeploymentPeerDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public SwitchoverDeploymentPeerDetails SwitchoverDeploymentPeerDetails { get; set; }
