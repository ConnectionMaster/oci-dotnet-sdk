...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/goldengate/CollectPipelineDiagnostic.cs.html">here</a> to see an example of how to use CollectPipelineDiagnostic request.
    /// </example>
    public class CollectPipelineDiagnosticRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "CollectPipelineDiagnosticDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public CollectPipelineDiagnosticDetails CollectPipelineDiagnosticDetails { get; set; }
