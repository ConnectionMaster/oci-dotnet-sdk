...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/goldengate/GenerateDisasterRecoveryPrecheckReport.cs.html">here</a> to see an example of how to use GenerateDisasterRecoveryPrecheckReport request.
    /// </example>
    public class GenerateDisasterRecoveryPrecheckReportRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "GenerateDisasterRecoveryPrecheckReportDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public GenerateDisasterRecoveryPrecheckReportDetails GenerateDisasterRecoveryPrecheckReportDetails { get; set; }
