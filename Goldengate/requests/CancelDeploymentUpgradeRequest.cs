...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/goldengate/CancelDeploymentUpgrade.cs.html">here</a> to see an example of how to use CancelDeploymentUpgrade request.
    /// </example>
    public class CancelDeploymentUpgradeRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "CancelDeploymentUpgradeDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public CancelDeploymentUpgradeDetails CancelDeploymentUpgradeDetails { get; set; }
