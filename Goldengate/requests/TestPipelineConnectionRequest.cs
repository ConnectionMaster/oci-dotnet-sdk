...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/goldengate/TestPipelineConnection.cs.html">here</a> to see an example of how to use TestPipelineConnection request.
    /// </example>
    public class TestPipelineConnectionRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "TestPipelineConnectionDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public TestPipelineConnectionDetails TestPipelineConnectionDetails { get; set; }
