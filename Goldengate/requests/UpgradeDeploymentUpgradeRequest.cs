...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/goldengate/UpgradeDeploymentUpgrade.cs.html">here</a> to see an example of how to use UpgradeDeploymentUpgrade request.
    /// </example>
    public class UpgradeDeploymentUpgradeRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UpgradeDeploymentUpgradeDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public UpgradeDeploymentUpgradeDetails UpgradeDeploymentUpgradeDetails { get; set; }
