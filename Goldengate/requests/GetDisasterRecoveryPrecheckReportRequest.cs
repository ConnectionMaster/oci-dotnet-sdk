...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/goldengate/GetDisasterRecoveryPrecheckReport.cs.html">here</a> to see an example of how to use GetDisasterRecoveryPrecheckReport request.
    /// </example>
    public class GetDisasterRecoveryPrecheckReportRequest : Oci.Common.IOciRequest
    {
        ...
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "faultDomain")]
