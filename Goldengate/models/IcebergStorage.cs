...
namespace Oci.GoldengateService.Models
{
    ...
    public class IcebergStorageModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(IcebergStorage);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(IcebergStorage);
            ...
            {
                logger.Warn($"The type {discriminator} is not present under IcebergStorage! Returning null value.");
            }
            return obj;
        }
    }
