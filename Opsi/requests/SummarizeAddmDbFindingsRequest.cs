...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/opsi/SummarizeAddmDbFindings.cs.html">here</a> to see an example of how to use SummarizeAddmDbFindings request.
    /// </example>
    public class SummarizeAddmDbFindingsRequest : Oci.Common.IOciRequest
    {
        ...
        public enum SortByEnum {
            [EnumMember(Value = "impactOverallPercent")]
            ImpactOverallPercent,
            [EnumMember(Value = "impactMaxPercent")]
            ImpactMaxPercent,
            [EnumMember(Value = "impactAvgActiveSessions")]
