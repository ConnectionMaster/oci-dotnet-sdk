...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/opsi/SummarizeAddmDbSchemaObjects.cs.html">here</a> to see an example of how to use SummarizeAddmDbSchemaObjects request.
    /// </example>
    public class SummarizeAddmDbSchemaObjectsRequest : Oci.Common.IOciRequest
    {
        ...
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "objectIdentifier", Oci.Common.Http.CollectionFormatType.Multi)]
        public System.Collections.Generic.List<int> ObjectIdentifier { get; set; }
