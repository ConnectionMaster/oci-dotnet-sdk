...
namespace Oci.OpsiService.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(CreateChargebackPlanDetailsModelConverter))]
    ...
    public class CreateChargebackPlanDetailsModelConverter : JsonConverter
    {
        public override bool CanWrite => false;
        public override bool CanRead => true;
        public override bool CanConvert(System.Type type)
        {
            return type == typeof(CreateChargebackPlanDetails);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(CreateChargebackPlanDetails);
            var discriminator = jsonObject["entitySource"].Value<string>();
            switch (discriminator)
            {
                case "CHARGEBACK_EXADATA":
                    obj = new CreateChargebackPlanExadataDetails();
                    break;
            }
