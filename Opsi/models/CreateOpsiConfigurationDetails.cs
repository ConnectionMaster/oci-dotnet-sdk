...
namespace Oci.OpsiService.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(CreateOpsiConfigurationDetailsModelConverter))]
    public class CreateOpsiConfigurationDetails 
    {
        ...
        public System.Collections.Generic.List<CreateConfigurationItemDetails> ConfigItems { get; set; }
        
    }

    public class CreateOpsiConfigurationDetailsModelConverter : JsonConverter
    {
        public override bool CanWrite => false;
        public override bool CanRead => true;
        public override bool CanConvert(System.Type type)
        {
            return type == typeof(CreateOpsiConfigurationDetails);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(CreateOpsiConfigurationDetails);
            var discriminator = jsonObject["opsiConfigType"].Value<string>();
            switch (discriminator)
            {
                case "UX_CONFIGURATION":
                    obj = new CreateOpsiUxConfigurationDetails();
                    break;
            }
