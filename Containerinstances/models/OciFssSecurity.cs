...
namespace Oci.ContainerinstancesService.Models
{
    ...
    public class OciFssSecurityModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(OciFssSecurity);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(OciFssSecurity);
            var discriminator = jsonObject["auth"].Value<string>();
            switch (discriminator)
            {
                case "SYS":
                    obj = new OciFssSysSecurity();
                    break;
            }
            if (obj != null)
            {
            ...
            {
                logger.Warn($"The type {discriminator} is not present under OciFssSecurity! Returning null value.");
            }
            return obj;
        }
    }
