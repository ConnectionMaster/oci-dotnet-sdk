...
{
    public class ListContainerImageSignaturesResponse : Oci.Common.OciResponse
    {
        ...
        public ContainerImageSignatureCollection ContainerImageSignatureCollection { get; set; }
