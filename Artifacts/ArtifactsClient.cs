...
namespace Oci.ArtifactsService
{
    ...
    public class ArtifactsClient : RegionalClientBase
    {
        ...
        {
            if (!DeveloperToolConfiguration.IsServiceEnabled("artifacts"))
            {
        ...
        public async Task<LookupContainerImageByUriResponse> LookupContainerImageByUri(LookupContainerImageByUriRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            Uri uri = new Uri(this.restClient.GetEndpoint(), System.IO.Path.Combine(basePathWithoutHost, "/container/images/actions/lookupImageByUri".Trim('/')));
            HttpMethod method = new HttpMethod("POST");
            HttpRequestMessage requestMessage = Converter.ToHttpRequestMessage(uri, method, request);
            requestMessage.Headers.Add("Accept", "application/json");
            GenericRetrier retryingClient = Retrier.GetPreferredRetrier(retryConfiguration, this.retryConfiguration);
            ...
            try
            {
                ...
                {
                    ServiceName = "Artifacts",
                    OperationName = "LookupContainerImageByUri",
                    RequestEndpoint = $"{method.Method} {requestMessage.RequestUri}",
                ...
                this.restClient.CheckHttpResponseMessage(requestMessage, responseMessage, apiDetails);
                logger.Debug($"Total Latency for this API call is: {stopWatch.ElapsedMilliseconds} ms");
                return Converter.FromHttpResponseMessage<LookupContainerImageByUriResponse>(responseMessage);
            }
            catch (OciException e)
            {
                logger.Error(e);
            ...
            {
                logger.Error($"LookupContainerImageByUri failed with error: {e.Message}");
                throw;
            }
        }
