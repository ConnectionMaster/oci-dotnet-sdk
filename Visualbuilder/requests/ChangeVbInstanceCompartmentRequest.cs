...
namespace Oci.VisualbuilderService.Requests
{
    ...
    public class ChangeVbInstanceCompartmentRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "ChangeVbInstanceCompartmentDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public ChangeVbInstanceCompartmentDetails ChangeVbInstanceCompartmentDetails { get; set; }
