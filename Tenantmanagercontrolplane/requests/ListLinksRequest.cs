...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/tenantmanagercontrolplane/ListLinks.cs.html">here</a> to see an example of how to use ListLinks request.
    /// </example>
    public class ListLinksRequest : Oci.Common.IOciRequest
    {
        
        /// <value>
        /// The ID of the parent tenancy this link is associated with.
        /// </value>
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "parentTenancyId")]
