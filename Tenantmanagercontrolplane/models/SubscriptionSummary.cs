...
namespace Oci.TenantmanagercontrolplaneService.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(SubscriptionSummaryModelConverter))]
    ...
    public class SubscriptionSummaryModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(SubscriptionSummary);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(SubscriptionSummary);
            var discriminator = jsonObject["entityVersion"].Value<string>();
            switch (discriminator)
            {
                case "V1":
                    obj = new ClassicSubscriptionSummary();
                    break;
                case "V2":
                    obj = new CloudSubscriptionSummary();
                    break;
            }
            if (obj != null)
            {
            ...
            {
                logger.Warn($"The type {discriminator} is not present under SubscriptionSummary! Returning null value.");
            }
            return obj;
        }
    }
