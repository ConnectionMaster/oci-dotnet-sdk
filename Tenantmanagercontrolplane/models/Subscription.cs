...
namespace Oci.TenantmanagercontrolplaneService.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(SubscriptionModelConverter))]
    ...
    public class SubscriptionModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(Subscription);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(Subscription);
            var discriminator = jsonObject["entityVersion"].Value<string>();
            switch (discriminator)
            {
                case "V1":
                    obj = new ClassicSubscription();
                    break;
                case "V2":
                    obj = new CloudSubscription();
                    break;
            }
            if (obj != null)
            {
            ...
            {
                logger.Warn($"The type {discriminator} is not present under Subscription! Returning null value.");
            }
            return obj;
        }
    }
