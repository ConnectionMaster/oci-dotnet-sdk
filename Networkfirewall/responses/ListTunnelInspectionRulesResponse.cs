...
{
    public class ListTunnelInspectionRulesResponse : Oci.Common.OciResponse
    {
        ...
        public TunnelInspectionRuleSummaryCollection TunnelInspectionRuleSummaryCollection { get; set; }
