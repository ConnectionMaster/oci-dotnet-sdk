...
{
    public class ListNetworkFirewallPoliciesResponse : Oci.Common.OciResponse
    {
        ...
        public NetworkFirewallPolicySummaryCollection NetworkFirewallPolicySummaryCollection { get; set; }
