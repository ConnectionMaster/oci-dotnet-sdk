...
{
    public class ListDecryptionProfilesResponse : Oci.Common.OciResponse
    {
        ...
        public DecryptionProfileSummaryCollection DecryptionProfileSummaryCollection { get; set; }
