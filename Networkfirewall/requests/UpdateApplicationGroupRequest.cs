...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/networkfirewall/UpdateApplicationGroup.cs.html">here</a> to see an example of how to use UpdateApplicationGroup request.
    /// </example>
    public class UpdateApplicationGroupRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UpdateApplicationGroupDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public UpdateApplicationGroupDetails UpdateApplicationGroupDetails { get; set; }
