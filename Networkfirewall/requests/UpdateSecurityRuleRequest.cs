...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/networkfirewall/UpdateSecurityRule.cs.html">here</a> to see an example of how to use UpdateSecurityRule request.
    /// </example>
    public class UpdateSecurityRuleRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UpdateSecurityRuleDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public UpdateSecurityRuleDetails UpdateSecurityRuleDetails { get; set; }
