...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/objectstorage/CreateBucket.cs.html">here</a> to see an example of how to use CreateBucket request.
    /// </example>
    public class CreateBucketRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "CreateBucketDetails is required.")]
