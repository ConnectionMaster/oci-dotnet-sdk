...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/databasemigration/ListDataVerificationTableRowCounts.cs.html">here</a> to see an example of how to use ListDataVerificationTableRowCounts request.
    /// </example>
    public class ListDataVerificationTableRowCountsRequest : Oci.Common.IOciRequest
    {
        ...
        /// 
        /// </value>
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "tableName")]
        ...
        public enum SortByEnum {
            [EnumMember(Value = "variancePercent")]
            VariancePercent,
            [EnumMember(Value = "owner")]
            Owner,
            [EnumMember(Value = "tableName")]
            TableName,
            [EnumMember(Value = "timeLastSourceStatisticsCollection")]
            TimeLastSourceStatisticsCollection,
            [EnumMember(Value = "timeLastTargetStatisticsCollection")]
            TimeLastTargetStatisticsCollection,
            [EnumMember(Value = "sourceRowCount")]
            SourceRowCount,
            [EnumMember(Value = "targetRowCount")]
            TargetRowCount
        };
