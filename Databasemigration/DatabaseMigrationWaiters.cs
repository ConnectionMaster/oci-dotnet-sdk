...
namespace Oci.DatabasemigrationService
{
    ...
    public class DatabaseMigrationWaiters
    {
        ...
        /// <param name="targetStates">Desired resource states. If multiple states are provided then the waiter will return once the resource reaches any of the provided states</param>
        /// <returns>a new Oci.common.Waiter instance</returns>
        public Waiter<GetDataVerificationDetailRequest, GetDataVerificationDetailResponse> ForDataVerificationDetail(GetDataVerificationDetailRequest request, params DataVerificationDetail.LifecycleStateEnum[] targetStates)
        {
            return this.ForDataVerificationDetail(request, WaiterConfiguration.DefaultWaiterConfiguration, targetStates);
        }
        ...
        /// <param name="targetStates">Desired resource states. If multiple states are provided then the waiter will return once the resource reaches any of the provided states</param>
        /// <returns>a new Oci.common.Waiter instance</returns>
        public Waiter<GetDataVerificationDetailRequest, GetDataVerificationDetailResponse> ForDataVerificationDetail(GetDataVerificationDetailRequest request, WaiterConfiguration config, params DataVerificationDetail.LifecycleStateEnum[] targetStates)
        {
            var agent = new WaiterAgent<GetDataVerificationDetailRequest, GetDataVerificationDetailResponse>(
                request,
                request => client.GetDataVerificationDetail(request),
                response => targetStates.Contains(response.DataVerificationDetail.LifecycleState.Value)
            );
            return new Waiter<GetDataVerificationDetailRequest, GetDataVerificationDetailResponse>(config, agent);
        }
        /// <summary>
        /// Creates a waiter using default wait configuration.
        /// </summary>
