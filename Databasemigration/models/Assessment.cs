...
namespace Oci.DatabasemigrationService.Models
{
    ...
    /// Assessment resource
    /// </summary>
    [JsonConverter(typeof(AssessmentModelConverter))]
    public class Assessment 
    {
        ...
        [JsonConverter(typeof(Oci.Common.Utils.ResponseEnumConverter))]
        public System.Nullable<AssessmentLifecycleStates> LifecycleState { get; set; }
        
        /// <value>
        /// The migration type of the migration to be performed.
        /// </value>
        [JsonProperty(PropertyName = "assessmentMigrationType")]
        [JsonConverter(typeof(Oci.Common.Utils.ResponseEnumConverter))]
        public System.Nullable<AssessmentMigrationTypes> AssessmentMigrationType { get; set; }
    ...
    public class AssessmentModelConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(Assessment);
            var discriminator = jsonObject["databaseCombination"].Value<string>();
            switch (discriminator)
            {
                case "MYSQL":
                    obj = new MySqlAssessment();
                    break;
                case "ORACLE":
                    obj = new OracleAssessment();
                    break;
            }
            if (obj != null)
            {
            ...
            {
                logger.Warn($"The type {discriminator} is not present under Assessment! Returning null value.");
            }
            return obj;
        }
    }
