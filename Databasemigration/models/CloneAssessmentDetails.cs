...
namespace Oci.DatabasemigrationService.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(CloneAssessmentDetailsModelConverter))]
    public class CloneAssessmentDetails 
    {
    ...
    public class CloneAssessmentDetailsModelConverter : JsonConverter
    {
        public override bool CanWrite => false;
        public override bool CanRead => true;
        public override bool CanConvert(System.Type type)
        {
            return type == typeof(CloneAssessmentDetails);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(CloneAssessmentDetails);
            var discriminator = jsonObject["databaseCombination"].Value<string>();
            switch (discriminator)
            {
                case "MYSQL":
                    obj = new MySqlCloneAssessmentDetails();
                    break;
                case "ORACLE":
                    obj = new OracleCloneAssessmentDetails();
                    break;
            }
