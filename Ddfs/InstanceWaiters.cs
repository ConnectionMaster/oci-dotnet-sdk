...
{
    /// <summary>
    /// Contains collection of helper methods to produce Oci.Common.Waiters for different resources of Instance.
    /// </summary>
    public class InstanceWaiters
    {
        private readonly InstanceClient client;

        public  InstanceWaiters(InstanceClient client)
        {
            this.client = client;
        }
        ...
        public Waiter<GetInstanceRequest, GetInstanceResponse> ForInstance(GetInstanceRequest request, WaiterConfiguration config, params Instance.LifecycleStateEnum[] targetStates)
        {
            var agent = new WaiterAgent<GetInstanceRequest, GetInstanceResponse>(
                ...
                targetStates.Contains(Instance.LifecycleStateEnum.Deleted)
            );
