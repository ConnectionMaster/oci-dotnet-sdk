...
using Oci.DdfsService.Models;

namespace Oci.DdfsService
{
    /// <summary>
    /// Collection of helper methods that can be used to provide an enumerator interface
    /// to any list operations of Instance where multiple pages of data may be fetched.
    ...
    public class InstancePaginators
    {
        ...
        public InstancePaginators(InstanceClient client)
        {
            this.client = client;
        }
        ...
        /// <param name="cancellationToken">The cancellation token object</param>
        /// <returns>The enumerator, which supports a simple iteration over a collection of a specified type</returns>
        public IEnumerable<InstanceSummary> ListInstancesRecordEnumerator(ListInstancesRequest request, Common.Retry.RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default)
        {
            return new Common.Utils.ResponseRecordEnumerable<ListInstancesRequest, ListInstancesResponse, InstanceSummary>(
                response => response.OpcNextPage,
                input =>
                {
                    if (!string.IsNullOrEmpty(input))
                ...
                request => client.ListInstances(request, retryConfiguration, cancellationToken),
                response => response.InstanceCollection.Items
            );
        }
