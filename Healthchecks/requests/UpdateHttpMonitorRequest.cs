...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/healthchecks/UpdateHttpMonitor.cs.html">here</a> to see an example of how to use UpdateHttpMonitor request.
    /// </example>
    public class UpdateHttpMonitorRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UpdateHttpMonitorDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public UpdateHttpMonitorDetails UpdateHttpMonitorDetails { get; set; }
