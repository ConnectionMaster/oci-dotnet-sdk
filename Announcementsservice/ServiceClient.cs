...
{
    /// <summary>Service client instance for Service.</summary>
    public class ServiceClient : RegionalClientBase
    {
        private readonly RetryConfiguration retryConfiguration;
        private const string basePathWithoutHost = "/20180904";

        public ServicePaginators Paginators { get; }
        ...
        public ServiceClient(IBasicAuthenticationDetailsProvider authenticationDetailsProvider, ClientConfiguration clientConfiguration = null, string endpoint = null)
            : base(authenticationDetailsProvider, clientConfiguration)
        {
            ...
            Paginators = new ServicePaginators(this);
        }
        ...
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/announcementsservice/ListServices.cs.html">here</a> to see an example of how to use ListServices API.</example>
