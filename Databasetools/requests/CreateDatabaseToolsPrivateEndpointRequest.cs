...
namespace Oci.DatabasetoolsService.Requests
{
    ...
    public class CreateDatabaseToolsPrivateEndpointRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "CreateDatabaseToolsPrivateEndpointDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public CreateDatabaseToolsPrivateEndpointDetails CreateDatabaseToolsPrivateEndpointDetails { get; set; }
