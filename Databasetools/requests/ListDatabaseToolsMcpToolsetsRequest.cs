...
{
    /// <example>
    /// Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/dot-net-examples/latest/databasetools/ListDatabaseToolsMcpToolsets.cs.html">here</a> to see an example of how to use ListDatabaseToolsMcpToolsets request.
    /// </example>
    public class ListDatabaseToolsMcpToolsetsRequest : Oci.Common.IOciRequest
    {
        ...
        public System.Collections.Generic.List<DatabaseToolsMcpToolsetType> Type { get; set; }
        
        /// <value>
        /// A filter to return only resources matching the specified `databaseToolsMcpServerId`.
        /// </value>
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "databaseToolsMcpServerId")]
