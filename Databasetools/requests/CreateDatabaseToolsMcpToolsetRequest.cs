...
namespace Oci.DatabasetoolsService.Requests
{
    ...
    public class CreateDatabaseToolsMcpToolsetRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "CreateDatabaseToolsMcpToolsetDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public CreateDatabaseToolsMcpToolsetDetails CreateDatabaseToolsMcpToolsetDetails { get; set; }
