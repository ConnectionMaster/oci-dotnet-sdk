...
{
    public class RemoveDatabaseToolsDatabaseApiGatewayConfigLockResponse : Oci.Common.OciResponse
    {
        ...
        public DatabaseToolsDatabaseApiGatewayConfig DatabaseToolsDatabaseApiGatewayConfig { get; set; }
