...
namespace Oci.DatabasetoolsService.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(DatabaseToolsSqlReportSummaryModelConverter))]
    public class DatabaseToolsSqlReportSummary 
    {
    ...
    public class DatabaseToolsSqlReportSummaryModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(DatabaseToolsSqlReportSummary);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(DatabaseToolsSqlReportSummary);
            var discriminator = jsonObject["type"].Value<string>();
            switch (discriminator)
            {
                case "ORACLE_DATABASE":
                    obj = new DatabaseToolsSqlReportSummaryOracleDatabase();
                    break;
            }
            if (obj != null)
            {
            ...
            {
                logger.Warn($"The type {discriminator} is not present under DatabaseToolsSqlReportSummary! Returning null value.");
            }
            return obj;
        }
    }
