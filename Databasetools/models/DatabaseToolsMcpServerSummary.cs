...
namespace Oci.DatabasetoolsService.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(DatabaseToolsMcpServerSummaryModelConverter))]
    ...
    public class DatabaseToolsMcpServerSummaryModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(DatabaseToolsMcpServerSummary);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(DatabaseToolsMcpServerSummary);
            var discriminator = jsonObject["type"].Value<string>();
            switch (discriminator)
            {
                case "DEFAULT":
                    obj = new DatabaseToolsMcpServerSummaryDefault();
                    break;
            }
            if (obj != null)
            {
            ...
            {
                logger.Warn($"The type {discriminator} is not present under DatabaseToolsMcpServerSummary! Returning null value.");
            }
            return obj;
        }
    }
