...
namespace Oci.DatabasetoolsService.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(DatabaseToolsIdentitySummaryModelConverter))]
    public class DatabaseToolsIdentitySummary 
    {
        ...
        public System.Nullable<DatabaseToolsIdentityLifecycleState> LifecycleState { get; set; }
    ...
    public class DatabaseToolsIdentitySummaryModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(DatabaseToolsIdentitySummary);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(DatabaseToolsIdentitySummary);
            var discriminator = jsonObject["type"].Value<string>();
            switch (discriminator)
            {
                case "ORACLE_DATABASE_RESOURCE_PRINCIPAL":
                    obj = new DatabaseToolsIdentityOracleDatabaseResourcePrincipalSummary();
                    break;
            }
            if (obj != null)
            {
            ...
            {
                logger.Warn($"The type {discriminator} is not present under DatabaseToolsIdentitySummary! Returning null value.");
            }
            return obj;
        }
    }
