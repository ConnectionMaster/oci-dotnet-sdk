...
namespace Oci.DatabasetoolsService.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(CreateDatabaseToolsIdentityDetailsModelConverter))]
    public class CreateDatabaseToolsIdentityDetails 
    {
    ...
    public class CreateDatabaseToolsIdentityDetailsModelConverter : JsonConverter
    {
        public override bool CanWrite => false;
        public override bool CanRead => true;
        public override bool CanConvert(System.Type type)
        {
            return type == typeof(CreateDatabaseToolsIdentityDetails);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(CreateDatabaseToolsIdentityDetails);
            var discriminator = jsonObject["type"].Value<string>();
            switch (discriminator)
            {
                case "ORACLE_DATABASE_RESOURCE_PRINCIPAL":
                    obj = new CreateDatabaseToolsIdentityOracleDatabaseResourcePrincipalDetails();
                    break;
            }
