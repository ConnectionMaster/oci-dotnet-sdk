...
namespace Oci.DatabasetoolsService.Models
{
    ...
    public class CreateDatabaseToolsSqlReportDetailsModelConverter : JsonConverter
    {
        public override bool CanWrite => false;
        public override bool CanRead => true;
        public override bool CanConvert(System.Type type)
        {
            return type == typeof(CreateDatabaseToolsSqlReportDetails);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(CreateDatabaseToolsSqlReportDetails);
            var discriminator = jsonObject["type"].Value<string>();
            switch (discriminator)
            {
                case "ORACLE_DATABASE":
                    obj = new CreateDatabaseToolsSqlReportOracleDatabaseDetails();
                    break;
            }
