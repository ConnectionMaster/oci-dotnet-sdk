...
namespace Oci.DatabasetoolsService.Models
{
    ...
    public class DatabaseToolsConnectionSummaryModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(DatabaseToolsConnectionSummary);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(DatabaseToolsConnectionSummary);
            var discriminator = jsonObject["type"].Value<string>();
            switch (discriminator)
            {
                case "POSTGRESQL":
                    obj = new DatabaseToolsConnectionPostgresqlSummary();
                    break;
                ...
                case "MYSQL":
                    ...
                    break;
                case "GENERIC_JDBC":
                    obj = new DatabaseToolsConnectionGenericJdbcSummary();
                    break;
            }
            if (obj != null)
            {
            ...
            {
                logger.Warn($"The type {discriminator} is not present under DatabaseToolsConnectionSummary! Returning null value.");
            }
            return obj;
        }
    }
