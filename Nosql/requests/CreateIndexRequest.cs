...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/nosql/CreateIndex.cs.html">here</a> to see an example of how to use CreateIndex request.
    /// </example>
    public class CreateIndexRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "CreateIndexDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public CreateIndexDetails CreateIndexDetails { get; set; }
