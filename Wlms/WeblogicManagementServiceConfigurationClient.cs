...
{
    /// <summary>Service client instance for WeblogicManagementServiceConfiguration.</summary>
    public class WeblogicManagementServiceConfigurationClient : RegionalClientBase
    {
        ...
        public WeblogicManagementServiceConfigurationClient(IBasicAuthenticationDetailsProvider authenticationDetailsProvider, ClientConfiguration clientConfiguration = null, string endpoint = null)
        ...
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/wlms/GetConfiguration.cs.html">here</a> to see an example of how to use GetConfiguration API.</example>
        ...
        /// <param name="completionOption">The completion option for this operation. Optional.</param>
        /// <returns>A response object containing details about the completed operation</returns>
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/wlms/UpdateConfiguration.cs.html">here</a> to see an example of how to use UpdateConfiguration API.</example>
