...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/filestorage/UpdateFilesystemSnapshotPolicy.cs.html">here</a> to see an example of how to use UpdateFilesystemSnapshotPolicy request.
    /// </example>
    public class UpdateFilesystemSnapshotPolicyRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UpdateFilesystemSnapshotPolicyDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public UpdateFilesystemSnapshotPolicyDetails UpdateFilesystemSnapshotPolicyDetails { get; set; }
