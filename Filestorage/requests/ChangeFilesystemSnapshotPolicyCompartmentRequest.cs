...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/filestorage/ChangeFilesystemSnapshotPolicyCompartment.cs.html">here</a> to see an example of how to use ChangeFilesystemSnapshotPolicyCompartment request.
    /// </example>
    public class ChangeFilesystemSnapshotPolicyCompartmentRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "ChangeFilesystemSnapshotPolicyCompartmentDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public ChangeFilesystemSnapshotPolicyCompartmentDetails ChangeFilesystemSnapshotPolicyCompartmentDetails { get; set; }
