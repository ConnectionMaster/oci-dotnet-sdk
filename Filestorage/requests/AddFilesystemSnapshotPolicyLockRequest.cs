...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/filestorage/AddFilesystemSnapshotPolicyLock.cs.html">here</a> to see an example of how to use AddFilesystemSnapshotPolicyLock request.
    /// </example>
    public class AddFilesystemSnapshotPolicyLockRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "AddFilesystemSnapshotPolicyLockDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public ResourceLock AddFilesystemSnapshotPolicyLockDetails { get; set; }
