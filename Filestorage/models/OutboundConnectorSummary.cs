...
namespace Oci.FilestorageService.Models
{
    ...
    /// 
    /// </summary>
    [JsonConverter(typeof(OutboundConnectorSummaryModelConverter))]
    public class OutboundConnectorSummary 
    {
    ...
    public class OutboundConnectorSummaryModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(OutboundConnectorSummary);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(OutboundConnectorSummary);
            var discriminator = jsonObject["connectorType"].Value<string>();
            switch (discriminator)
            {
                case "LDAPBIND":
                    obj = new LdapBindAccountSummary();
                    break;
            }
            if (obj != null)
            {
            ...
            {
                logger.Warn($"The type {discriminator} is not present under OutboundConnectorSummary! Returning null value.");
            }
            return obj;
        }
    }
