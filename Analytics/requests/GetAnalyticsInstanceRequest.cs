...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/analytics/GetAnalyticsInstance.cs.html">here</a> to see an example of how to use GetAnalyticsInstance request.
    /// </example>
    public class GetAnalyticsInstanceRequest : Oci.Common.IOciRequest
    {
