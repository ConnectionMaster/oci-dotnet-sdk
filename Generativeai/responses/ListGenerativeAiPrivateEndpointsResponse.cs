...
{
    public class ListGenerativeAiPrivateEndpointsResponse : Oci.Common.OciResponse
    {
        ...
        public GenerativeAiPrivateEndpointCollection GenerativeAiPrivateEndpointCollection { get; set; }
