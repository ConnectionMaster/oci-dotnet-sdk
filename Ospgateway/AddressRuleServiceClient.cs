...
{
    /// <summary>Service client instance for AddressRuleService.</summary>
    public class AddressRuleServiceClient : RegionalClientBase
    {
        ...
        public AddressRuleServiceClient(IBasicAuthenticationDetailsProvider authenticationDetailsProvider, ClientConfiguration clientConfiguration = null, string endpoint = null)
        ...
        public async Task<GetAddressRuleResponse> GetAddressRule(GetAddressRuleRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            Uri uri = new Uri(this.restClient.GetEndpoint(), System.IO.Path.Combine(basePathWithoutHost, "/addressRules/{countryCode}".Trim('/')));
            ...
            try
            {
                ...
                return Converter.FromHttpResponseMessage<GetAddressRuleResponse>(responseMessage);
            }
            ...
            {
                logger.Error($"GetAddressRule failed with error: {e.Message}");
                throw;
            }
        }
