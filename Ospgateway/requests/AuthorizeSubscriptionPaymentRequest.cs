...
namespace Oci.OspgatewayService.Requests
{
    ...
    public class AuthorizeSubscriptionPaymentRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "AuthorizeSubscriptionPaymentDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public AuthorizeSubscriptionPaymentDetails AuthorizeSubscriptionPaymentDetails { get; set; }
