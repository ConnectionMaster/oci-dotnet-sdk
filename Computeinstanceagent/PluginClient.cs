...
namespace Oci.ComputeinstanceagentService
{
    ...
    public class PluginClient : RegionalClientBase
    {
        ...
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/computeinstanceagent/GetInstanceAgentPlugin.cs.html">here</a> to see an example of how to use GetInstanceAgentPlugin API.</example>
        ...
        /// <param name="completionOption">The completion option for this operation. Optional.</param>
        /// <returns>A response object containing details about the completed operation</returns>
        /// <example>Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/computeinstanceagent/ListInstanceAgentPlugins.cs.html">here</a> to see an example of how to use ListInstanceAgentPlugins API.</example>
