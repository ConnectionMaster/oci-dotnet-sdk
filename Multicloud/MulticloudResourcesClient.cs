...
{
    /// <summary>Service client instance for MulticloudResources.</summary>
    public class MulticloudResourcesClient : RegionalClientBase
    {
        private readonly RetryConfiguration retryConfiguration;
        private const string basePathWithoutHost = "/20180828";

        public MulticloudResourcesPaginators Paginators { get; }
        ...
        public MulticloudResourcesClient(IBasicAuthenticationDetailsProvider authenticationDetailsProvider, ClientConfiguration clientConfiguration = null, string endpoint = null)
            : base(authenticationDetailsProvider, clientConfiguration)
        {
            ...
            Paginators = new MulticloudResourcesPaginators(this);
        }
        ...
        public async Task<ListMulticloudResourcesResponse> ListMulticloudResources(ListMulticloudResourcesRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            Uri uri = new Uri(this.restClient.GetEndpoint(), System.IO.Path.Combine(basePathWithoutHost, "/omHub/multicloudResources".Trim('/')));
            ...
            try
            {
                ...
                {
                    ServiceName = "MulticloudResources",
                    OperationName = "ListMulticloudResources",
                ...
                return Converter.FromHttpResponseMessage<ListMulticloudResourcesResponse>(responseMessage);
            }
            ...
            {
                logger.Error($"ListMulticloudResources failed with error: {e.Message}");
                throw;
            }
        }
