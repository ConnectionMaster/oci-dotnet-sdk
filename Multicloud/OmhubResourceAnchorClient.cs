...
{
    /// <summary>Service client instance for OmhubResourceAnchor.</summary>
    public class OmhubResourceAnchorClient : RegionalClientBase
    {
            ...
            : base(authenticationDetailsProvider, clientConfiguration)
        {
            ...
            Paginators = new OmhubResourceAnchorPaginators(this);
            Waiters = new OmhubResourceAnchorWaiters(this);
        }
        ...
        public async Task<GetResourceAnchorResponse> GetResourceAnchor(GetResourceAnchorRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            Uri uri = new Uri(this.restClient.GetEndpoint(), System.IO.Path.Combine(basePathWithoutHost, "/resourceAnchors/{resourceAnchorId}".Trim('/')));
            ...
            try
            {
                ...
                {
                    ServiceName = "OmhubResourceAnchor",
                    OperationName = "GetResourceAnchor",
                ...
                return Converter.FromHttpResponseMessage<GetResourceAnchorResponse>(responseMessage);
            }
            ...
            {
                logger.Error($"GetResourceAnchor failed with error: {e.Message}");
                throw;
            }
        }
        ...
        public async Task<ListResourceAnchorsResponse> ListResourceAnchors(ListResourceAnchorsRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            Uri uri = new Uri(this.restClient.GetEndpoint(), System.IO.Path.Combine(basePathWithoutHost, "/resourceAnchors".Trim('/')));
            HttpMethod method = new HttpMethod("GET");
            HttpRequestMessage requestMessage = Converter.ToHttpRequestMessage(uri, method, request);
            requestMessage.Headers.Add("Accept", "application/json");
            GenericRetrier retryingClient = Retrier.GetPreferredRetrier(retryConfiguration, this.retryConfiguration);
            ...
            try
            {
                ...
                {
                    ServiceName = "OmhubResourceAnchor",
                    OperationName = "ListResourceAnchors",
                    RequestEndpoint = $"{method.Method} {requestMessage.RequestUri}",
                ...
                this.restClient.CheckHttpResponseMessage(requestMessage, responseMessage, apiDetails);
                logger.Debug($"Total Latency for this API call is: {stopWatch.ElapsedMilliseconds} ms");
                return Converter.FromHttpResponseMessage<ListResourceAnchorsResponse>(responseMessage);
            }
            catch (OciException e)
            {
                logger.Error(e);
            ...
            {
                logger.Error($"ListResourceAnchors failed with error: {e.Message}");
                throw;
            }
        }
