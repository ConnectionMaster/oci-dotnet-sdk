...
{
    /// <summary>Service client instance for MulticloudPolicies.</summary>
    public class MulticloudPoliciesClient : RegionalClientBase
    {
        private readonly RetryConfiguration retryConfiguration;
        private const string basePathWithoutHost = "/20180828";

        public MulticloudPoliciesPaginators Paginators { get; }
        ...
        public MulticloudPoliciesClient(IBasicAuthenticationDetailsProvider authenticationDetailsProvider, ClientConfiguration clientConfiguration = null, string endpoint = null)
            : base(authenticationDetailsProvider, clientConfiguration)
        {
            ...
            service = new Service
            {
                ServiceName = "MULTICLOUDPOLICIES",
            ...
            Paginators = new MulticloudPoliciesPaginators(this);
        }
        ...
        public async Task<ListMulticloudPoliciesResponse> ListMulticloudPolicies(ListMulticloudPoliciesRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            Uri uri = new Uri(this.restClient.GetEndpoint(), System.IO.Path.Combine(basePathWithoutHost, "/multicloudpolicies".Trim('/')));
            ...
            try
            {
                ...
                {
                    ServiceName = "MulticloudPolicies",
                    OperationName = "ListMulticloudPolicies",
                ...
                return Converter.FromHttpResponseMessage<ListMulticloudPoliciesResponse>(responseMessage);
            }
            ...
            {
                logger.Error($"ListMulticloudPolicies failed with error: {e.Message}");
                throw;
            }
        }
