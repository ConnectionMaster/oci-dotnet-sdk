...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/multicloud/ListExternalLocationMappingMetadata.cs.html">here</a> to see an example of how to use ListExternalLocationMappingMetadata request.
    /// </example>
    public class ListExternalLocationMappingMetadataRequest : Oci.Common.IOciRequest
    {
        ...
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "subscriptionServiceName", Oci.Common.Http.CollectionFormatType.Multi)]
