...
{
    public class ListRecommendationStrategiesResponse : Oci.Common.OciResponse
    {
        ...
        public RecommendationStrategyCollection RecommendationStrategyCollection { get; set; }
