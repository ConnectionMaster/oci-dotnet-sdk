...
namespace Oci.DbmulticloudService
{
    ...
    public class DbMulticloudGCPProviderClient : RegionalClientBase
    {
        ...
        public async Task<ReplicateOracleDbGcpKeyRingResponse> ReplicateOracleDbGcpKeyRing(ReplicateOracleDbGcpKeyRingRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            Uri uri = new Uri(this.restClient.GetEndpoint(), System.IO.Path.Combine(basePathWithoutHost, "/oracleDbGcpKeyRing/{oracleDbGcpKeyRingId}/actions/replicate".Trim('/')));
            HttpMethod method = new HttpMethod("POST");
            HttpRequestMessage requestMessage = Converter.ToHttpRequestMessage(uri, method, request);
            requestMessage.Headers.Add("Accept", "application/json");
            GenericRetrier retryingClient = Retrier.GetPreferredRetrier(retryConfiguration, this.retryConfiguration);
            ...
            try
            {
                ...
                {
                    ServiceName = "DbMulticloudGCPProvider",
                    OperationName = "ReplicateOracleDbGcpKeyRing",
                    RequestEndpoint = $"{method.Method} {requestMessage.RequestUri}",
                ...
                this.restClient.CheckHttpResponseMessage(requestMessage, responseMessage, apiDetails);
                logger.Debug($"Total Latency for this API call is: {stopWatch.ElapsedMilliseconds} ms");
                return Converter.FromHttpResponseMessage<ReplicateOracleDbGcpKeyRingResponse>(responseMessage);
            }
            catch (OciException e)
            {
                logger.Error(e);
            ...
            {
                logger.Error($"ReplicateOracleDbGcpKeyRing failed with error: {e.Message}");
                throw;
            }
        }
