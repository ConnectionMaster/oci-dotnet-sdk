...
{
    /// <summary>Service client instance for OracleDbAzureKey.</summary>
    public class OracleDbAzureKeyClient : RegionalClientBase
    {
        private readonly RetryConfiguration retryConfiguration;
        private const string basePathWithoutHost = "/20240501";

        public OracleDbAzureKeyPaginators Paginators { get; }

        public OracleDbAzureKeyWaiters Waiters { get; }
        ...
        public OracleDbAzureKeyClient(IBasicAuthenticationDetailsProvider authenticationDetailsProvider, ClientConfiguration clientConfiguration = null, string endpoint = null)
            : base(authenticationDetailsProvider, clientConfiguration)
        {
            ...
            Paginators = new OracleDbAzureKeyPaginators(this);
            Waiters = new OracleDbAzureKeyWaiters(this);
        }
        ...
        public async Task<GetOracleDbAzureKeyResponse> GetOracleDbAzureKey(GetOracleDbAzureKeyRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            Uri uri = new Uri(this.restClient.GetEndpoint(), System.IO.Path.Combine(basePathWithoutHost, "/oracleDbAzureKey/{oracleDbAzureKeyId}".Trim('/')));
            ...
            try
            {
                ...
                return Converter.FromHttpResponseMessage<GetOracleDbAzureKeyResponse>(responseMessage);
            }
            ...
            {
                logger.Error($"GetOracleDbAzureKey failed with error: {e.Message}");
                throw;
            }
        }
        ...
        public async Task<ListOracleDbAzureKeysResponse> ListOracleDbAzureKeys(ListOracleDbAzureKeysRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            Uri uri = new Uri(this.restClient.GetEndpoint(), System.IO.Path.Combine(basePathWithoutHost, "/oracleDbAzureKey".Trim('/')));
            HttpMethod method = new HttpMethod("GET");
            HttpRequestMessage requestMessage = Converter.ToHttpRequestMessage(uri, method, request);
            requestMessage.Headers.Add("Accept", "application/json");
            GenericRetrier retryingClient = Retrier.GetPreferredRetrier(retryConfiguration, this.retryConfiguration);
            ...
            try
            {
                ...
                this.restClient.CheckHttpResponseMessage(requestMessage, responseMessage, apiDetails);
                logger.Debug($"Total Latency for this API call is: {stopWatch.ElapsedMilliseconds} ms");
                return Converter.FromHttpResponseMessage<ListOracleDbAzureKeysResponse>(responseMessage);
            }
            catch (OciException e)
            {
                logger.Error(e);
            ...
            {
                logger.Error($"ListOracleDbAzureKeys failed with error: {e.Message}");
                throw;
            }
        }
