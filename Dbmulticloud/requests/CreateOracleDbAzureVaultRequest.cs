...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/dbmulticloud/CreateOracleDbAzureVault.cs.html">here</a> to see an example of how to use CreateOracleDbAzureVault request.
    /// </example>
    public class CreateOracleDbAzureVaultRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "CreateOracleDbAzureVaultDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public CreateOracleDbAzureVaultDetails CreateOracleDbAzureVaultDetails { get; set; }
