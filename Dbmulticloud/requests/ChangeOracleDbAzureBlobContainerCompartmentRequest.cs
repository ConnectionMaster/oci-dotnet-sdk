...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/dbmulticloud/ChangeOracleDbAzureBlobContainerCompartment.cs.html">here</a> to see an example of how to use ChangeOracleDbAzureBlobContainerCompartment request.
    /// </example>
    public class ChangeOracleDbAzureBlobContainerCompartmentRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "OracleDbAzureBlobContainerId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "oracleDbAzureBlobContainerId")]
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "ChangeOracleDbAzureBlobContainerCompartmentDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public ChangeOracleDbAzureBlobContainerCompartmentDetails ChangeOracleDbAzureBlobContainerCompartmentDetails { get; set; }
