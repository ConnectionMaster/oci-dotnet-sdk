...
namespace Oci.DbmulticloudService.Requests
{
    ...
    public class ChangeOracleDbGcpIdentityConnectorCompartmentRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "ChangeOracleDbGcpIdentityConnectorCompartmentDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public ChangeOracleDbGcpIdentityConnectorCompartmentDetails ChangeOracleDbGcpIdentityConnectorCompartmentDetails { get; set; }
