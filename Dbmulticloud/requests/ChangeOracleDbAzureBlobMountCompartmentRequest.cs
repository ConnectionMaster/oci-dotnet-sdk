...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/dbmulticloud/ChangeOracleDbAzureBlobMountCompartment.cs.html">here</a> to see an example of how to use ChangeOracleDbAzureBlobMountCompartment request.
    /// </example>
    public class ChangeOracleDbAzureBlobMountCompartmentRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "OracleDbAzureBlobMountId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "oracleDbAzureBlobMountId")]
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "ChangeOracleDbAzureBlobMountCompartmentDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public ChangeOracleDbAzureBlobMountCompartmentDetails ChangeOracleDbAzureBlobMountCompartmentDetails { get; set; }
