...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/dbmulticloud/ChangeMultiCloudResourceDiscoveryCompartment.cs.html">here</a> to see an example of how to use ChangeMultiCloudResourceDiscoveryCompartment request.
    /// </example>
    public class ChangeMultiCloudResourceDiscoveryCompartmentRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "MultiCloudResourceDiscoveryId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "multiCloudResourceDiscoveryId")]
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "ChangeMultiCloudResourceDiscoveryCompartmentDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public ChangeMultiCloudResourceDiscoveryCompartmentDetails ChangeMultiCloudResourceDiscoveryCompartmentDetails { get; set; }
