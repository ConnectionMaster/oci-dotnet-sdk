...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/dbmulticloud/ListOracleDbGcpKeys.cs.html">here</a> to see an example of how to use ListOracleDbGcpKeys request.
    /// </example>
    public class ListOracleDbGcpKeysRequest : Oci.Common.IOciRequest
    {
        ...
        /// </value>
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "oracleDbGcpKeyRingId")]
        public string OracleDbGcpKeyRingId { get; set; }
        
        /// <value>
        /// A filter to return Oracle DB Google Cloud Key resources.
        /// </value>
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "oracleDbGcpKeyId")]
        ...
        public System.Nullable<OracleDbGcpKey.LifecycleStateEnum> LifecycleState { get; set; }
