...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/dbmulticloud/CreateOracleDbAzureVaultAssociation.cs.html">here</a> to see an example of how to use CreateOracleDbAzureVaultAssociation request.
    /// </example>
    public class CreateOracleDbAzureVaultAssociationRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "CreateOracleDbAzureVaultAssociationDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public CreateOracleDbAzureVaultAssociationDetails CreateOracleDbAzureVaultAssociationDetails { get; set; }
