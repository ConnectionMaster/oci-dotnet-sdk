...
namespace Oci.DbmulticloudService
{
    ...
    public class DbMulticloudAwsProviderClient : RegionalClientBase
    {
        ...
        public async Task<ReplicateOracleDbAwsKeyResponse> ReplicateOracleDbAwsKey(ReplicateOracleDbAwsKeyRequest request, RetryConfiguration retryConfiguration = null, CancellationToken cancellationToken = default, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead)
        {
            ...
            Uri uri = new Uri(this.restClient.GetEndpoint(), System.IO.Path.Combine(basePathWithoutHost, "/oracleDbAwsKey/{oracleDbAwsKeyId}/actions/replicate".Trim('/')));
            HttpMethod method = new HttpMethod("POST");
            HttpRequestMessage requestMessage = Converter.ToHttpRequestMessage(uri, method, request);
            requestMessage.Headers.Add("Accept", "application/json");
            GenericRetrier retryingClient = Retrier.GetPreferredRetrier(retryConfiguration, this.retryConfiguration);
            ...
            try
            {
                ...
                {
                    ServiceName = "DbMulticloudAwsProvider",
                    OperationName = "ReplicateOracleDbAwsKey",
                    RequestEndpoint = $"{method.Method} {requestMessage.RequestUri}",
                ...
                this.restClient.CheckHttpResponseMessage(requestMessage, responseMessage, apiDetails);
                logger.Debug($"Total Latency for this API call is: {stopWatch.ElapsedMilliseconds} ms");
                return Converter.FromHttpResponseMessage<ReplicateOracleDbAwsKeyResponse>(responseMessage);
            }
            catch (OciException e)
            {
                logger.Error(e);
            ...
            {
                logger.Error($"ReplicateOracleDbAwsKey failed with error: {e.Message}");
                throw;
            }
        }
