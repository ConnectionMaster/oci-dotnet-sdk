...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/blockchain/UpdateOsn.cs.html">here</a> to see an example of how to use UpdateOsn request.
    /// </example>
    public class UpdateOsnRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "OsnId is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Path, "osnId")]
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "UpdateOsnDetails is required.")]
