...
namespace Oci.WafService.Requests
{
    ...
    public class ChangeNetworkAddressListCompartmentRequest : Oci.Common.IOciRequest
    {
        ...
        /// Required
        /// </remarks>
        [Required(ErrorMessage = "ChangeNetworkAddressListCompartmentDetails is required.")]
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Body)]
        public ChangeNetworkAddressListCompartmentDetails ChangeNetworkAddressListCompartmentDetails { get; set; }
