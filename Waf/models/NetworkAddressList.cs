...
namespace Oci.WafService.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(NetworkAddressListModelConverter))]
    ...
    public class NetworkAddressListModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(NetworkAddressList);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(NetworkAddressList);
            var discriminator = jsonObject["type"].Value<string>();
            switch (discriminator)
            {
                case "ADDRESSES":
                    obj = new NetworkAddressListAddresses();
                    break;
                case "VCN_ADDRESSES":
                    obj = new NetworkAddressListVcnAddresses();
                    break;
            }
            if (obj != null)
            {
            ...
            {
                logger.Warn($"The type {discriminator} is not present under NetworkAddressList! Returning null value.");
            }
            return obj;
        }
    }
