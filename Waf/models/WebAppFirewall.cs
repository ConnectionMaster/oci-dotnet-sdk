...
namespace Oci.WafService.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(WebAppFirewallModelConverter))]
    public class WebAppFirewall 
    {
    ...
    public class WebAppFirewallModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(WebAppFirewall);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(WebAppFirewall);
            var discriminator = jsonObject["backendType"].Value<string>();
            switch (discriminator)
            {
                case "LOAD_BALANCER":
                    obj = new WebAppFirewallLoadBalancer();
                    break;
            }
            if (obj != null)
            {
            ...
            {
                logger.Warn($"The type {discriminator} is not present under WebAppFirewall! Returning null value.");
            }
            return obj;
        }
    }
