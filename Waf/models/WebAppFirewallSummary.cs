...
namespace Oci.WafService.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(WebAppFirewallSummaryModelConverter))]
    public class WebAppFirewallSummary 
    {
    ...
    public class WebAppFirewallSummaryModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(WebAppFirewallSummary);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(WebAppFirewallSummary);
