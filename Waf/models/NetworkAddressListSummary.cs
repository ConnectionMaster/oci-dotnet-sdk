...
namespace Oci.WafService.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(NetworkAddressListSummaryModelConverter))]
    public class NetworkAddressListSummary 
    {
    ...
    public class NetworkAddressListSummaryModelConverter : JsonConverter
    {
        ...
        {
            return type == typeof(NetworkAddressListSummary);
        }
        ...
        public override object ReadJson(JsonReader reader, System.Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var obj = default(NetworkAddressListSummary);
            var discriminator = jsonObject["type"].Value<string>();
            switch (discriminator)
            {
                case "VCN_ADDRESSES":
                    obj = new NetworkAddressListVcnAddressesSummary();
                    break;
                case "ADDRESSES":
