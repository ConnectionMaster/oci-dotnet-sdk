...
namespace Oci.MarketplaceprivateofferService.Models
{
    ...
    public class OfferQuote 
    {
        ...
        /// </value>
        ///
        public enum OfferQuoteStatusEnum {
            /// This value is used if a service returns a value for this enum that is not recognized by this version of the SDK.
            [EnumMember(Value = null)]
            UnknownEnumValue,
            [EnumMember(Value = "DRAFT")]
            Draft,
            [EnumMember(Value = "PENDING_ISV")]
            PendingIsv,
            [EnumMember(Value = "PENDING_ISV_UPDATE")]
            PendingIsvUpdate,
            [EnumMember(Value = "PENDING_RESELLER")]
            PendingReseller,
            [EnumMember(Value = "RESELLER_ACCEPTED")]
            ResellerAccepted,
            [EnumMember(Value = "BUYER_ACCEPTED")]
            BuyerAccepted,
            [EnumMember(Value = "ACTIVE")]
            Active,
            ...
            FailedAccept,
            [EnumMember(Value = "FAILED_RESPOND")]
            FailedRespond
        };
        ...
        [JsonConverter(typeof(Oci.Common.Utils.ResponseEnumConverter))]
        public System.Nullable<OfferQuoteStatusEnum> OfferQuoteStatus { get; set; }
