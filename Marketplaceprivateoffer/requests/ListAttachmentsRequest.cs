...
{
    /// <example>
    /// Click <a href="https://docs.oracle.com/en-us/iaas/tools/dot-net-examples/latest/marketplaceprivateoffer/ListAttachments.cs.html">here</a> to see an example of how to use ListAttachments request.
    /// </example>
    public class ListAttachmentsRequest : Oci.Common.IOciRequest
    {
        ...
        /// </value>
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "buyerCompartmentId")]
        public string BuyerCompartmentId { get; set; }
        
        /// <value>
        /// The ID of the seller compartment this offer is associated with.
        /// </value>
        [Oci.Common.Http.HttpConverter(Oci.Common.Http.TargetEnum.Query, "sellerCompartmentId")]
